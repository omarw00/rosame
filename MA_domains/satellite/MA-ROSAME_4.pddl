...
(:action switch_on
	...
	:precondition (and (calibrated ?b) (on_board ?b ?a) (power_avail ?a))
	:effect (and (power_on ?b) (not (calibrated ?b))  (not (power_avail ?a))))

(:action switch_off
	:parameters (?a - satellite ?b - instrument)
	:precondition (and (calibrated ?b) (on_board ?b ?a) (power_on ?b))
	:effect (and (power_avail ?a) (not (power_on ?b))))
