...
(:action drive-truck
	...
	(<= (* (driven ) -1) 0)
	(<= (* (walked ) -1) 0)
	(<= (+ (* (driven ) -0.1245) (+ (* (time-to-drive ?c ?b) -0.9896) (* (walked ) -0.0725))) -53.4364)
	...
	(<= (+ (* (walked ) -0.0461) (* (time-to-drive ?c ?b) -0.9989)) -16.9819)
	(<= (+ (* (walked ) 0.0076) (+ (* (driven ) -0.1632) (* (time-to-drive ?c ?b) -0.9866))) -53.2746)
