...
(:action drive-truck
	...
	(<= (+ (* (driven ) 0.1000) (+ (* (time-to-drive ?c ?b) 0.8898) (* (walked ) -0.4452))) 77.3442)
	...
	(<= (+ (* (driven ) 0.1476) (+ (* (time-to-drive ?c ?b) 0.9538) (* (walked ) -0.2618))) 111.3774)
	(<= (+ (* (driven ) 0.1662) (+ (* (time-to-drive ?c ?b) -0.0690) (* (walked ) -0.9837))) 13.4504)
	...
	(<= (+ (* (time-to-drive ?c ?b) 0.7356) (+ (* (driven ) 0.1226) (* (walked ) -0.6662))) 64.9791)
	...
	(<= (+ (* (walked ) 0.2193) (+ (* (time-to-drive ?c ?b) 0.4387) (* (driven ) -0.8715))) 46.2820)
	(<= (+ (* (walked ) 0.2544) (+ (* (driven ) -0.5344) (* (time-to-drive ?c ?b) -0.8061))) -10.4789)
	(<= (+ (* (walked ) 0.2726) (+ (* (driven ) -0.8240) (* (time-to-drive ?c ?b) -0.4967))) -6.4577)
	(<= (+ (* (walked ) 0.2755) (+ (* (time-to-drive ?c ?b) -0.0459) (* (driven ) -0.9602))) 19.9296)
...
(:action walk
	...
	(<= (+ (* (driven ) 0.0940) (+ (* (walked ) -0.1749) (* (time-to-walk ?c ?b) -0.9801))) -4.6741)
	(<= (+ (* (driven ) 0.0948) (+ (* (walked ) -0.1046) (* (time-to-walk ?c ?b) -0.9900))) 71.9239)
	(<= (+ (* (driven ) 0.1666) (+ (* (time-to-walk ?c ?b) -0.9278) (* (walked ) -0.3337))) -7.8789)
	(<= (+ (* (driven ) 0.1838) (+ (* (walked ) -0.5682) (* (time-to-walk ?c ?b) -0.8021))) -18.4487)
	(<= (+ (* (driven ) 0.2029) (+ (* (time-to-walk ?c ?b) 0.8841) (* (walked ) -0.4210))) 78.2213)
	(<= (+ (* (driven ) 0.2287) (+ (* (time-to-walk ?c ?b) -0.6348) (* (walked ) -0.7381))) -14.5998)
	...
	(<= (+ (* (time-to-walk ?c ?b) -1) (+ (* (walked ) 0.0003) (* (driven ) -0.0007))) -2.0311)
	(<= (+ (* (time-to-walk ?c ?b) 0.1045) (+ (* (driven ) 0.4422) (* (walked ) -0.8908))) 55.6657)
	(<= (+ (* (time-to-walk ?c ?b) 0.1603) (+ (* (walked ) 0.2749) (* (driven ) -0.9480))) 16.1258)
	...
	(<= (+ (* (time-to-walk ?c ?b) 0.8638) (+ (* (driven ) -0.1245) (* (walked ) -0.4882))) 40.5981)
	...
	(<= (+ (* (walked ) -0.0615) (+ (* (driven ) -0.2591) (* (time-to-walk ?c ?b) -0.9639))) -22.1692)
	(<= (+ (* (walked ) 0.0169) (+ (* (driven ) -0.0058) (* (time-to-walk ?c ?b) -0.9998))) 5.6193)
	(<= (+ (* (walked ) 0.0235) (+ (* (driven ) -0.0121) (* (time-to-walk ?c ?b) -0.9997))) 0.6118)
	(<= (+ (* (walked ) 0.1029) (+ (* (time-to-walk ?c ?b) -0.9580) (* (driven ) -0.2675))) -14.3249)
	...
	(<= (+ (* (walked ) 0.2703) (+ (* (time-to-walk ?c ?b) 0.2027) (* (driven ) -0.9412))) 18.3806)
