...
(:action save_person
	...
	(<= (+ (* (d ?t) 0.3841) (+ (* (x ?b) 0.7682) (* (y ?b) -0.5121))) 0.3841)
	...
	(<= (+ (* (x ?b) 0.4334) (+ (* (y ?b) 0.5993) (* (d ?t) -0.6731))) 11.2948)
	(<= (+ (* (x ?b) 0.5774) (+ (* (y ?b) 0.5774) (* (d ?t) -0.5774))) 14.4338)
	(<= (+ (* (x ?b) 0.7071) (* (y ?b) 0.7071)) 70.7107)
	(<= (+ (* (x ?b) 0.9635) (+ (* (d ?t) 0.1606) (* (y ?b) -0.2141))) 7.5476)
	...
	(<= (+ (* (y ?b) 0.4031) (+ (* (x ?b) 0.2968) (* (d ?t) -0.8657))) 1.0498)
