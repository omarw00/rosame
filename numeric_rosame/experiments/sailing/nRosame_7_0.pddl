...
(:action save_person
	...
	(<= (+ (* (d ?b) 0.3403) (+ (* (x ?a) -0.8129) (* (y ?a) -0.4726))) -1.8716)
	(<= (+ (* (d ?b) 0.4657) (+ (* (y ?a) -0.5433) (* (x ?a) -0.6985))) -1.6299)
	...
	(<= (+ (* (y ?a) 0.3557) (+ (* (d ?b) -0.7862) (* (x ?a) -0.5054))) -2.3024)
	(<= (+ (* (y ?a) 0.4007) (+ (* (x ?a) -0.5159) (* (d ?b) -0.7572))) -1.6937)
