...
(:action save_person
	...
	(<= (+ (* (x ?a) 0.5123) (+ (* (y ?a) 0.5898) (* (d ?b) -0.6242))) 13.0230)
	(<= (+ (* (x ?a) 0.5774) (+ (* (y ?a) 0.5774) (* (d ?b) -0.5774))) 14.4338)
	(<= (+ (* (x ?a) 0.6467) (+ (* (d ?b) 0.5174) (* (y ?a) -0.5605))) 0.1293)
	(<= (+ (* (x ?a) 0.7071) (* (y ?a) 0.7071)) 70.7107)
	(<= (+ (* (x ?a) 0.9307) (+ (* (d ?b) 0.2482) (* (y ?a) -0.2689))) 7.1971)
	(<= (+ (* (x ?a) 0.9883) (+ (* (d ?b) 0.1140) (* (y ?a) -0.1014))) 10.8332)
	(<= (+ (* (y ?a) -0.6750) (+ (* (d ?b) -0.0460) (* (x ?a) -0.7364))) -2.1171)
	(<= (+ (* (y ?a) 0.2827) (+ (* (x ?a) 0.1539) (* (d ?b) -0.9468))) 0.6549)
