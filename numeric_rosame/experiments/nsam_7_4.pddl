...
(:action drive-truck
	...
	(<= (+ (* (walked ) 0.0312) (+ (* (time-to-drive ?loc-to ?loc-from) 0.0282) (* (driven ) -0.9991))) 5.0204)
	(<= (+ (* (walked ) 0.0340) (+ (* (time-to-drive ?loc-to ?loc-from) 0.0344) (* (driven ) -0.9988))) 5.7465)
...
(:action walk
	...
	(<= (* (driven ) -1) 0)
	(<= (* (walked ) -1) 0)
	(<= (+ (* (driven ) 0.1195) (+ (* (walked ) 0.0106) (* (time-to-walk ?loc-to ?loc-from) 0.9928))) 82.1166)
	...
	(<= (+ (* (time-to-walk ?loc-to ?loc-from) 0.9935) (+ (* (driven ) 0.1134) (* (walked ) -0.0098))) 80.8137)
	(<= (+ (* (walked ) 0.0214) (+ (* (time-to-walk ?loc-to ?loc-from) 0.0004) (* (driven ) -0.9998))) 1.4624)
	(<= (+ (* (walked ) 0.0494) (+ (* (time-to-walk ?loc-to ?loc-from) -0.1895) (* (driven ) -0.9806))) -1.3762)
	(<= (+ (* (walked ) 0.0516) (+ (* (time-to-walk ?loc-to ?loc-from) 0.1193) (* (driven ) -0.9915))) 13.2403)
	(<= (+ (* (walked ) 0.0698) (+ (* (driven ) -0.9491) (* (time-to-walk ?loc-to ?loc-from) -0.3071))) -2.4566)
	(<= (+ (* (walked ) 0.1763) (+ (* (driven ) 0.1313) (* (time-to-walk ?loc-to ?loc-from) -0.9755))) -7.8043)
