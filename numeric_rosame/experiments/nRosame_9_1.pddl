...
(:action drive-truck
	...
	(<= (+ (* (driven ) 0.0746) (+ (* (walked ) -0.1357) (* (time-to-drive ?c ?b) -0.9879))) 1.2489)
	...
	(<= (+ (* (time-to-drive ?c ?b) 0.9885) (+ (* (driven ) -0.0958) (* (walked ) -0.1167))) 82.0486)
	...
	(<= (+ (* (walked ) -0.0107) (+ (* (driven ) -0.0959) (* (time-to-drive ?c ?b) -0.9953))) -12.9393)
	(<= (+ (* (walked ) 0.0090) (+ (* (driven ) -0.0052) (* (time-to-drive ?c ?b) -0.9999))) -5.4302)
	(<= (+ (* (walked ) 0.0246) (+ (* (driven ) -0.0402) (* (time-to-drive ?c ?b) -0.9989))) -8.3324)
	...
	(<= (+ (* (walked ) 0.1893) (+ (* (driven ) -0.2891) (* (time-to-drive ?c ?b) -0.9384))) 3.7650)
	(<= (+ (* (walked ) 0.2926) (+ (* (driven ) -0.5187) (* (time-to-drive ?c ?b) -0.8033))) 10.8529)
	(<= (+ (* (walked ) 0.2971) (+ (* (time-to-drive ?c ?b) -0.7959) (* (driven ) -0.5276))) 11.4124)
	(<= (+ (* (walked ) 0.3065) (+ (* (time-to-drive ?c ?b) -0.1992) (* (driven ) -0.9308))) 24.2097)
	...
	(<= (+ (time-to-drive ?c ?b) (+ (* (driven ) 0.0032) (* (walked ) -0.0026))) 99.6289)
...
(:action walk
	...
	(<= (+ (* (driven ) 0.0039) (+ (* (walked ) -0.0763) (* (time-to-walk ?c ?b) -0.9971))) -14.3886)
	(<= (+ (* (driven ) 0.0176) (+ (* (time-to-walk ?c ?b) 0.9991) (* (walked ) -0.0386))) 93.9153)
	(<= (+ (* (driven ) 0.0201) (+ (* (walked ) -0.0422) (* (time-to-walk ?c ?b) -0.9989))) -6.8483)
	(<= (+ (* (driven ) 0.0225) (+ (* (time-to-walk ?c ?b) 0.9986) (* (walked ) -0.0480))) 93.8678)
	(<= (+ (* (driven ) 0.0271) (+ (* (time-to-walk ?c ?b) -0.9982) (* (walked ) -0.0530))) -4.8773)
	...
	(<= (+ (* (time-to-walk ?c ?b) -0.9983) (+ (* (driven ) -0.0113) (* (walked ) -0.0564))) -12.7247)
	(<= (+ (* (time-to-walk ?c ?b) -1) (+ (* (driven ) -0.0002) (* (walked ) -0.0008))) -2.1498)
	(<= (+ (* (time-to-walk ?c ?b) 0.3801) (+ (* (driven ) 0.7024) (* (walked ) -0.6018))) 1032.1895)
	(<= (+ (* (time-to-walk ?c ?b) 0.4545) (+ (* (walked ) 0.2699) (* (driven ) -0.8489))) 48.0928)
	...
	(<= (+ (* (walked ) 0.0226) (+ (* (time-to-walk ?c ?b) -0.9997) (* (driven ) -0.0113))) 1.2661)
	(<= (+ (* (walked ) 0.1111) (+ (* (time-to-walk ?c ?b) 0.9597) (* (driven ) -0.2581))) 90.2122)
	(<= (+ (* (walked ) 0.1483) (+ (* (time-to-walk ?c ?b) -0.9840) (* (driven ) -0.0984))) 17.7907)
	(<= (+ (* (walked ) 0.1712) (+ (* (time-to-walk ?c ?b) 0.8562) (* (driven ) -0.4875))) 80.4807)
	(<= (+ (* (walked ) 0.2270) (+ (* (driven ) -0.1597) (* (time-to-walk ?c ?b) -0.9607))) 27.7172)
	(<= (+ (* (walked ) 0.3240) (+ (* (time-to-walk ?c ?b) -0.9170) (* (driven ) -0.2327))) 50.3882)
	(<= (+ (* (walked ) 0.3242) (+ (* (driven ) -0.5281) (* (time-to-walk ?c ?b) -0.7849))) 20.9512)
	(<= (+ (* (walked ) 0.3369) (+ (* (time-to-walk ?c ?b) 0.9105) (* (driven ) -0.2398))) 177.8034)
	(<= (+ (* (walked ) 0.3506) (+ (* (time-to-walk ?c ?b) -0.0835) (* (driven ) -0.9328))) 28.7818)
	(<= (+ (* (walked ) 0.3804) (+ (* (time-to-walk ?c ?b) -0.6459) (* (driven ) -0.6619))) 26.7853)
