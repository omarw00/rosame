...
(:action drive-truck
	...
	(<= (+ (* (driven ) 0.0949) (+ (* (walked ) -0.1726) (* (time-to-drive ?c ?b) -0.9804))) 2.9728)
	...
	(<= (+ (* (driven ) 0.1754) (+ (* (walked ) -0.2944) (* (time-to-drive ?c ?b) -0.9395))) 30.8022)
	(<= (+ (* (driven ) 0.1761) (+ (* (walked ) -0.2956) (* (time-to-drive ?c ?b) -0.9390))) 31.0444)
	...
	(<= (+ (* (driven ) 0.2495) (+ (* (time-to-drive ?c ?b) 0.8519) (* (walked ) -0.4604))) 111.4933)
	(<= (+ (* (driven ) 0.2628) (+ (* (walked ) -0.1053) (* (time-to-drive ?c ?b) -0.9591))) 622.8169)
	(<= (+ (* (driven ) 0.2812) (+ (* (time-to-drive ?c ?b) 0.8073) (* (walked ) -0.5188))) 116.4913)
	(<= (+ (* (driven ) 0.3725) (+ (* (time-to-drive ?c ?b) 0.8702) (* (walked ) -0.3225))) 552.2185)
	(<= (+ (* (driven ) 0.3877) (+ (* (walked ) -0.6629) (* (time-to-drive ?c ?b) -0.6405))) 109.7526)
	...
	(<= (+ (* (walked ) 0.2726) (+ (* (driven ) -0.8240) (* (time-to-drive ?c ?b) -0.4967))) -6.4577)
	(<= (+ (* (walked ) 0.2783) (+ (* (time-to-drive ?c ?b) -0.4109) (* (driven ) -0.8682))) -1.0073)
...
(:action walk
	...
	(<= (* (driven ) -1) 0)
	(<= (* (walked ) -1) 0)
	(<= (+ (* (driven ) -0.0144) (+ (* (walked ) -0.1146) (* (time-to-walk ?c ?b) -0.9933))) -22.8460)
	...
	(<= (+ (* (time-to-walk ?c ?b) -0.9937) (+ (* (driven ) -0.0920) (* (walked ) -0.0634))) -22.8559)
	...
	(<= (+ (* (time-to-walk ?c ?b) 0.9640) (+ (* (driven ) 0.1178) (* (walked ) -0.2384))) 90.6147)
	...
	(<= (+ (* (walked ) 0.3359) (+ (* (time-to-walk ?c ?b) -0.5263) (* (driven ) -0.7812))) 5.2626)
