...
(:action drive
	...
	(<= (+ (* (current_load ?x) 0.0139) (* (fuel-cost ) -0.9999)) -0.9999)
...
(:action drop
	...
	(not (clear ?y))
	(not (on ?y ?z))
	(<= (+ (* (fuel-cost ) -0.1618) (* (weight ?y) -0.9868)) -20.1086)
	(<= (+ (* (fuel-cost ) -0.6493) (* (weight ?y) -0.7606)) -39.1041)
	...
	(<= (+ (* (weight ?y) 0.8805) (* (fuel-cost ) -0.4741)) 60.2107)
...
(:action load
	...
	(<= (+ (* (current_load ?z) 0.0229) (+ (* (load_limit ?z) 0.1133) (+ (* (weight ?y) -0.0668) (* (fuel-cost ) -0.9910)))) 35.5048)
	...
	(<= (+ (* (current_load ?z) 0.2659) (+ (* (fuel-cost ) 0.0960) (+ (* (weight ?y) 0.8944) (* (load_limit ?z) -0.3467)))) -3.8959)
	(<= (+ (* (current_load ?z) 0.2905) (+ (* (weight ?y) 0.7662) (+ (* (fuel-cost ) 0.5723) (* (load_limit ?z) 0.0328)))) 157.6392)
	...
	(<= (+ (* (fuel-cost ) 0.1930) (+ (* (current_load ?z) 0.1087) (+ (* (weight ?y) 0.9648) (* (load_limit ?z) -0.1418)))) 65.7018)
	...
	(<= (+ (* (load_limit ?z) 0.0577) (+ (* (weight ?y) 0.7343) (+ (* (current_load ?z) 0.3802) (* (fuel-cost ) 0.5594)))) 175.0330)
	...
	(<= (+ (* (weight ?y) 0.6611) (+ (* (current_load ?z) 0.3418) (+ (* (fuel-cost ) 0.5350) (* (load_limit ?z) 0.3999)))) 291.4710)
	(<= (+ (* (weight ?y) 0.6933) (+ (* (fuel-cost ) 0.5698) (+ (* (current_load ?z) 0.3081) (* (load_limit ?z) 0.3159)))) 260.2557)
	(<= (+ (* (weight ?y) 0.7401) (+ (* (fuel-cost ) 0.5835) (+ (* (current_load ?z) 0.3289) (* (load_limit ?z) 0.0607)))) 171.3450)
	(<= (+ (* (weight ?y) 0.7706) (+ (* (current_load ?z) 0.2308) (+ (* (fuel-cost ) 0.5557) (* (load_limit ?z) 0.2100)))) 216.6866)
	(<= (+ (* (weight ?y) 0.7782) (+ (* (load_limit ?z) 0.1709) (+ (* (fuel-cost ) 0.5575) (* (current_load ?z) 0.2332)))) 202.9875)
	(<= (+ (* (weight ?y) 0.7968) (+ (* (current_load ?z) 0.4156) (+ (* (fuel-cost ) 0.4360) (* (load_limit ?z) -0.0477)))) 138.8343)
	...
	(<= (+ (* (weight ?y) 0.8829) (+ (* (fuel-cost ) 0.0644) (+ (* (current_load ?z) 0.3011) (* (load_limit ?z) -0.3546)))) -5.1911)
	(<= (+ (* (weight ?y) 0.8911) (+ (* (fuel-cost ) 0.3461) (+ (* (current_load ?z) 0.2230) (* (load_limit ?z) -0.1909)))) 63.3855)
	...
	(<= (+ (* (weight ?y) 0.9035) (+ (* (fuel-cost ) 0.1807) (+ (* (current_load ?z) 0.2472) (* (load_limit ?z) -0.3000)))) 17.0621)
...
(:action unload
	...
	(<= (+ (* (fuel-cost ) 0.2072) (+ (* (current_load ?z) 0.4301) (+ (* (load_limit ?z) 0.4664) (* (weight ?y) -0.7447)))) 243.5868)
	...
	(<= (+ (* (load_limit ?z) 0.0291) (+ (* (weight ?y) 0.9282) (+ (* (fuel-cost ) -0.3651) (* (current_load ?z) -0.0659)))) 66.8271)
	...
	(<= (+ (* (load_limit ?z) 0.4578) (+ (* (current_load ?z) 0.4365) (+ (* (fuel-cost ) 0.2614) (* (weight ?y) -0.7291)))) 245.1065)
	...
	(<= (+ (* (weight ?y) 0.9562) (+ (* (fuel-cost ) -0.2800) (+ (* (load_limit ?z) -0.0048) (* (current_load ?z) -0.0856)))) 56.8824)
