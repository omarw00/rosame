...
(:action drive-truck
	...
	(<= (+ (* (driven ) 0.3866) (+ (* (time-to-drive ?c ?b) -0.1606) (* (walked ) -0.9081))) 31.2881)
	...
	(<= (+ (* (time-to-drive ?c ?b) 0.1274) (+ (* (driven ) 0.4502) (* (walked ) -0.8838))) 58.4436)
...
(:action walk
	...
	(<= (+ (* (walked ) 0.2740) (+ (* (time-to-walk ?c ?b) 0.1644) (* (driven ) -0.9476))) 16.1687)
