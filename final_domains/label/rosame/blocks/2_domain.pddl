...
(:action unstack
  :parameters (?a - object ?b - object)
  :precondition (and (arm-empty) (clear ?a) (clear ?b) (on-table ?a) (holding ?a) (holding ?b) (on ?b ?a))
  :effect (and (not (arm-empty)) (not (clear ?a)) (not (clear ?b)) (not (on-table ?a)) (not (holding ?a)) (not (holding ?b)) (not (on ?b ?a))))
