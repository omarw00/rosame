...
(:action stack
  ...
  :precondition (and (arm-empty) (on-table ?a) (on-table ?b) (holding ?a) (holding ?b) (on ?a ?b) (on ?b ?a))
  :effect (and (clear ?a) (clear ?b) (not (arm-empty)) (not (on-table ?a)) (not (on-table ?b)) (not (holding ?a)) (not (holding ?b)) (not (on ?a ?b)) (not (on ?b ?a))))
