...
(:action stack
  ...
  :precondition (and (arm-empty) (clear ?a) (on-table ?a) (on-table ?b) (holding ?a) (holding ?b) (on ?a ?b))
  :effect (and (clear ?b) (on ?b ?a)))

(:action unstack
  :parameters (?a - block ?b - block)
  :precondition (and (arm-empty) (clear ?a) (clear ?b) (on-table ?a) (on-table ?b) (holding ?a) (holding ?b) (on ?a ?b) (on ?b ?a))
  :effect (and (not (arm-empty)) (not (clear ?a)) (not (clear ?b)) (not (on-table ?a)) (not (on-table ?b)) (not (holding ?b)) (not (on ?a ?b))))
