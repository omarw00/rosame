...
(:action unstack
  :parameters (?a - block ?b - block)
  :precondition (and (arm-empty) (clear ?a) (clear ?b) (on-table ?a) (holding ?a) (holding ?b) (on ?a ?b) (on ?b ?a))
  :effect (and (on-table ?b) (not (arm-empty)) (not (clear ?a)) (not (clear ?b)) (not (on-table ?a)) (not (holding ?a)) (not (holding ?b)) (not (on ?a ?b)) (not (on ?b ?a))))
