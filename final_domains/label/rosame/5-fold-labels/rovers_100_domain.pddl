...
(:action navigate
  ...
  :effect (and (at ?a ?c) (available ?a) (not (at ?a ?b))))
...
(:action sample_rock
  :parameters (?a - rover ?b - store ?c - waypoint)
  :precondition (and (at ?a ?c) (empty ?b) (available ?a) (at_rock_sample ?c))
