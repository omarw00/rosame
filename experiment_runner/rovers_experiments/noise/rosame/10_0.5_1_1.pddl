...
(:action navigate
	...
	:precondition (and (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_soil_data ?b) (communicated_soil_data ?c) (at_soil_sample ?b) (at_soil_sample ?c) (at_rock_sample ?b))
...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and )
	:effect (and (available ?a) (at_rock_sample ?c)))
