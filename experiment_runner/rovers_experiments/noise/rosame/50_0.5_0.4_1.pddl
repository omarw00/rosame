...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (empty ?b) (store_of ?a ?b))
	:effect (and (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (full ?b)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_image_data ?b ?c) (at_soil_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and ))
