...
(:action take_image
	...
	:precondition (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (have_image ?b ?c ?d) (communicated_rock_data ?e) (at_soil_sample ?e) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and  (not (at ?d ?e))  (not (equipped_for_soil_analysis ?d))  (not (equipped_for_rock_analysis ?d))  (not (have_rock_analysis ?d ?e))  (not (have_soil_analysis ?d ?e))  (not (calibrated ?a ?d))  (not (have_image ?b ?c ?d))  (not (communicated_rock_data ?e))  (not (at_soil_sample ?e))  (not (at_rock_sample ?e))  (not (visible_from ?c ?e))  (not (calibration_target ?a ?c))  (not (on_board ?a ?d))))
