...
(:action sample_soil
	...
	:effect (and (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (at_rock_sample ?c)))
...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?c))  (not (at ?b ?e))  (not (can_traverse ?b ?c ?d))  (not (can_traverse ?b ?c ?e))  (not (can_traverse ?b ?e ?c))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_soil_analysis ?b))  (not (equipped_for_rock_analysis ?b))  (not (available ?b))  (not (visible ?c ?d))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?c))  (not (communicated_soil_data ?d))  (not (communicated_rock_data ?c))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))))
