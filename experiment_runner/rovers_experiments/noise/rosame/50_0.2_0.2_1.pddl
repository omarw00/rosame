...
(:action drop
	...
	:effect (and (full ?b) (store_of ?a ?b) (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (available ?a))))
