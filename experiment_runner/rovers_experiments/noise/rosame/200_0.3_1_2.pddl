...
(:action drop
	...
	:precondition (and (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (available ?a) (store_of ?a ?b))
	:effect (and (equipped_for_soil_analysis ?a) (full ?b)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?f) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (available ?d) (communicated_image_data ?b ?c) (at_rock_sample ?f) (channel_free ?a))
	:effect (and ))
