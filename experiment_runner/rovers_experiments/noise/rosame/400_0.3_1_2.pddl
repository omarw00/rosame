...
(:action navigate
	...
	:precondition (and (at ?a ?c) (can_traverse ?a ?b ?c) (available ?a))
...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (available ?b) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
