...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?d))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?c ?e))  (not (can_traverse ?b ?e ?c))  (not (can_traverse ?b ?e ?d))  (not (available ?b))  (not (visible ?c ?d))  (not (communicated_soil_data ?e))))
