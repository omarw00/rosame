...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (have_soil_analysis ?a ?c))
	:effect (and (at ?a ?c) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (full ?b) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b) (not (equipped_for_soil_analysis ?a))  (not (have_soil_analysis ?a ?c))))
...
(:action sample_rock
	...
	:effect (and  (not (at ?a ?c))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (available ?a))  (not (communicated_soil_data ?c))))
