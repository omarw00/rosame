...
(:action sample_soil
	...
	:effect (and (have_soil_analysis ?a ?c) (full ?b) (not (at_soil_sample ?c))))

(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_rock_analysis ?a) (empty ?b) (available ?a) (communicated_rock_data ?c) (store_of ?a ?b))
	:effect (and (at ?a ?c) (have_rock_analysis ?a ?c) (not (empty ?b))))
...
(:action take_image
	...
	:precondition (and (have_image ?b ?c ?d))
	:effect (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (communicated_soil_data ?e) (communicated_rock_data ?e) (communicated_image_data ?b ?c) (at_soil_sample ?e) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d)))
