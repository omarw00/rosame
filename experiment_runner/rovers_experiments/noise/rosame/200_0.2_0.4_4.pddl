...
(:action sample_soil
	...
	:effect (and  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (store_of ?a ?b))))
...
(:action drop
	...
	:effect (and (available ?a) (store_of ?a ?b) (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (full ?b))))
