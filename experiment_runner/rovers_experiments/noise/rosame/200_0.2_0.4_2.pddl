...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (at_soil_sample ?c))
	:effect (and (full ?b) (available ?a) (not (equipped_for_soil_analysis ?a))  (not (equipped_for_imaging ?a))  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (at_soil_sample ?c))))
