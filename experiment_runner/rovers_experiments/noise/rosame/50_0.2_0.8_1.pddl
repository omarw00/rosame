...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (available ?a) (communicated_rock_data ?c) (at_rock_sample ?c))
	:effect (and (empty ?b) (not (at ?a ?c))  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (available ?a))  (not (communicated_rock_data ?c))  (not (at_rock_sample ?c))))
