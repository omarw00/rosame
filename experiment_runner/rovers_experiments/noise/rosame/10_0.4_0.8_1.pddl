...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?e) (equipped_for_soil_analysis ?b) (have_soil_analysis ?b ?c) (communicated_rock_data ?c))
	:effect (and  (not (have_soil_analysis ?b ?c))  (not (communicated_rock_data ?c))))
