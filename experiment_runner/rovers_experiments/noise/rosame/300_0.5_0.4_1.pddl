...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_rock_analysis ?a) (empty ?b) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c))
	:effect (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (at_rock_sample ?c) (store_of ?a ?b) (not (equipped_for_rock_analysis ?a))  (not (empty ?b))  (not (available ?a))  (not (communicated_soil_data ?c))  (not (at_soil_sample ?c))))
