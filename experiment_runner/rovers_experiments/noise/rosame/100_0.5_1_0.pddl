...
(:action take_image
	...
	:precondition (and (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (at_rock_sample ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and (have_image ?b ?c ?d) (not (calibrated ?a ?d))))

(:action communicate_soil_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?d) (available ?b) (communicated_soil_data ?e) (communicated_rock_data ?e) (at_rock_sample ?c) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (have_rock_analysis ?d ?e) (available ?d) (communicated_soil_data ?f) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (at_rock_sample ?f) (channel_free ?a))
	:effect (and ))
