...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and )
	:effect (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c)))
...
(:action drop
	...
	:effect (and  (not (available ?a))  (not (store_of ?a ?b))))
...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?e))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?c))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_soil_analysis ?b))  (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?d))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?c))  (not (have_soil_analysis ?b ?e))  (not (visible ?c ?e))  (not (visible ?d ?c))  (not (visible ?d ?e))  (not (visible ?e ?d))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (communicated_rock_data ?e))  (not (at_rock_sample ?d))))
