...
(:action take_image
	...
	:precondition (and (equipped_for_soil_analysis ?d) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_image_data ?b ?c) (at_rock_sample ?e) (on_board ?a ?d))
	:effect (and (calibrated ?a ?d) (not (have_image ?b ?c ?d))))
