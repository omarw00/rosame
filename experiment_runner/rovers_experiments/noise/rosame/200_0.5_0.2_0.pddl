...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?c))  (not (can_traverse ?b ?d ?e))  (not (equipped_for_soil_analysis ?b))  (not (equipped_for_imaging ?b))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (at_rock_sample ?c))))
