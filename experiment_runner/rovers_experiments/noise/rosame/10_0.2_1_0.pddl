...
(:action take_image
	...
	:precondition (and (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (communicated_soil_data ?e) (at_soil_sample ?e) (on_board ?a ?d))
