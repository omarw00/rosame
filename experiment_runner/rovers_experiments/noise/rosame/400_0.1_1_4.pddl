...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?f) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (available ?d) (communicated_image_data ?b ?c) (at_rock_sample ?f) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
