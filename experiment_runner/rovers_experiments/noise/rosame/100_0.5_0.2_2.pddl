...
(:action navigate
	...
	:precondition (and (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_imaging ?a) (available ?a) (visible ?b ?c) (visible ?c ?b) (communicated_soil_data ?b) (communicated_soil_data ?c) (communicated_rock_data ?b) (communicated_rock_data ?c))
	:effect (and (at ?a ?c)))
