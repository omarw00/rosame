...
(:action calibrate
	...
	:precondition (and (at ?c ?d) (equipped_for_soil_analysis ?c) (equipped_for_imaging ?c) (have_soil_analysis ?c ?d) (visible_from ?b ?d) (calibration_target ?a ?b))
	:effect (and  (not (at ?c ?d))  (not (equipped_for_soil_analysis ?c))  (not (equipped_for_imaging ?c))  (not (have_soil_analysis ?c ?d))  (not (visible_from ?b ?d))  (not (calibration_target ?a ?b))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?f) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (at_rock_sample ?e) (at_rock_sample ?f) (channel_free ?a))
