...
(:action sample_soil
	...
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (full ?b) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (store_of ?a ?b))
...
(:action sample_rock
	...
	:effect (and (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (at_rock_sample ?c) (not (empty ?b))  (not (full ?b))))
