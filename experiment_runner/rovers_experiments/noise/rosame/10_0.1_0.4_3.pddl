...
(:action take_image
	...
	:precondition (and (communicated_image_data ?b ?c))
	:effect (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_rock_data ?e) (at_soil_sample ?e) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d) (not (communicated_image_data ?b ?c))))
