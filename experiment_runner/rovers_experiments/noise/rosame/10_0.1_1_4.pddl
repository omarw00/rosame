...
(:action calibrate
	...
	:precondition (and (equipped_for_soil_analysis ?c) (equipped_for_imaging ?c) (have_rock_analysis ?c ?d) (have_soil_analysis ?c ?d) (calibrated ?a ?c) (communicated_soil_data ?d) (at_rock_sample ?d) (visible_from ?b ?d) (calibration_target ?a ?b))
	:effect (and (at ?c ?d) (equipped_for_rock_analysis ?c) (available ?c) (communicated_rock_data ?d) (at_soil_sample ?d) (on_board ?a ?c) (not (equipped_for_soil_analysis ?c))  (not (equipped_for_imaging ?c))  (not (have_rock_analysis ?c ?d))  (not (have_soil_analysis ?c ?d))  (not (calibrated ?a ?c))  (not (communicated_soil_data ?d))  (not (at_rock_sample ?d))  (not (visible_from ?b ?d))  (not (calibration_target ?a ?b))))
