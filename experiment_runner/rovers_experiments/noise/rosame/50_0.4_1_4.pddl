...
(:action navigate
	...
	:precondition (and (at ?a ?c) (can_traverse ?a ?b ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (available ?a))
...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?e) (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (have_soil_analysis ?b ?c) (available ?b) (visible ?e ?d) (at_rock_sample ?c) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
