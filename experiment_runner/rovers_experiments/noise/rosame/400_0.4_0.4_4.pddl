...
(:action sample_soil
	...
	:precondition (and (at ?a ?c) (equipped_for_rock_analysis ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and ))
