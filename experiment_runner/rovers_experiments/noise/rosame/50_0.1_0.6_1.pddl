...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (available ?a) (visible ?b ?c) (visible ?c ?b) (communicated_soil_data ?c) (at_rock_sample ?c))
...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (full ?b) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (have_soil_analysis ?a ?c)))
...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (have_soil_analysis ?b ?c) (available ?b) (visible ?c ?e) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (at_soil_sample ?e) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?d) (visible ?c ?e) (visible ?d ?c) (communicated_soil_data ?c) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?e) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d))
	:effect (and (at ?b ?c) (at ?b ?d) (at ?b ?e) (at_lander ?a ?d) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?d) (communicated_rock_data ?d) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?e) (channel_free ?a) (not (at_lander ?a ?c))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?c ?e))  (not (can_traverse ?b ?d ?c))  (not (have_rock_analysis ?b ?d))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?d))  (not (visible ?c ?e))  (not (visible ?d ?c))  (not (communicated_soil_data ?c))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?e))  (not (at_soil_sample ?e))  (not (at_rock_sample ?c))  (not (at_rock_sample ?d))))
