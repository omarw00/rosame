...
(:action calibrate
	...
	:effect (and  (not (at ?c ?d))  (not (equipped_for_soil_analysis ?c))  (not (equipped_for_imaging ?c))  (not (have_rock_analysis ?c ?d))  (not (have_soil_analysis ?c ?d))  (not (calibrated ?a ?c))  (not (available ?c))  (not (communicated_rock_data ?d))  (not (at_soil_sample ?d))  (not (visible_from ?b ?d))  (not (calibration_target ?a ?b))))
