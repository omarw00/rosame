...
(:action navigate
	...
	:precondition (and (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?b))
	:effect (and (at ?a ?b) (at ?a ?c) (equipped_for_soil_analysis ?a) (have_soil_analysis ?a ?c) (communicated_soil_data ?c)))
...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (available ?a) (at_rock_sample ?c))
	:effect (and (empty ?b) (have_soil_analysis ?a ?c) (full ?b) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (store_of ?a ?b)))

(:action drop
	:parameters (?a - rover ?b - store)
	:precondition (and (equipped_for_soil_analysis ?a) (full ?b) (available ?a))
...
(:action take_image
	...
	:precondition (and (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?e) (at_soil_sample ?e) (at_rock_sample ?e) (on_board ?a ?d))
