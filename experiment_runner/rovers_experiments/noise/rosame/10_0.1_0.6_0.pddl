...
(:action drop
	...
	:effect (and  (not (equipped_for_rock_analysis ?a))  (not (store_of ?a ?b))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (available ?d) (visible ?e ?f) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
