...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_imaging ?a) (available ?a) (communicated_rock_data ?c))
	:effect (and  (not (equipped_for_imaging ?a))  (not (available ?a))  (not (communicated_rock_data ?c))))
