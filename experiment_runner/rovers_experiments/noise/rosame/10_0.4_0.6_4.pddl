...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and (at ?a ?c) (empty ?b) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (available ?a))  (not (communicated_soil_data ?c))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
...
(:action calibrate
	...
	:precondition (and (at ?c ?d) (equipped_for_soil_analysis ?c) (calibrated ?a ?c) (available ?c) (communicated_rock_data ?d) (visible_from ?b ?d))
	:effect (and (equipped_for_rock_analysis ?c) (equipped_for_imaging ?c) (have_rock_analysis ?c ?d) (have_soil_analysis ?c ?d) (communicated_soil_data ?d) (at_soil_sample ?d) (at_rock_sample ?d) (calibration_target ?a ?b) (on_board ?a ?c)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (available ?d) (visible ?e ?f) (have_image ?b ?c ?d) (at_soil_sample ?f) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
