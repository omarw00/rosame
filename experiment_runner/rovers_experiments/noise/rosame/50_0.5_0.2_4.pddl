...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (available ?a) (store_of ?a ?b))
	:effect (and (equipped_for_rock_analysis ?a) (empty ?b) (full ?b) (not (equipped_for_soil_analysis ?a))  (not (available ?a))  (not (store_of ?a ?b))))

(:action calibrate
	:parameters (?a - camera ?b - objective ?c - rover ?d - waypoint)
	:precondition (and (at ?c ?d) (equipped_for_soil_analysis ?c) (equipped_for_imaging ?c) (available ?c) (communicated_soil_data ?d) (visible_from ?b ?d) (calibration_target ?a ?b) (on_board ?a ?c))
	:effect (and (calibrated ?a ?c)))

(:action take_image
	:parameters (?a - camera ?b - mode ?c - objective ?d - rover ?e - waypoint)
	:precondition (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (communicated_soil_data ?e) (communicated_image_data ?b ?c) (visible_from ?c ?e) (on_board ?a ?d))
