...
(:action sample_soil
	...
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (have_soil_analysis ?a ?c) (available ?a) (communicated_soil_data ?c))
	:effect (and (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b)))
