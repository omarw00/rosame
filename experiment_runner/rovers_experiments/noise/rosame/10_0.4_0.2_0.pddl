...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (full ?b) (available ?a) (store_of ?a ?b))
	:effect (and  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (full ?b))  (not (available ?a))  (not (store_of ?a ?b))))
...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?e))  (not (can_traverse ?b ?e ?c))  (not (have_rock_analysis ?b ?c))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (visible ?e ?d))  (not (communicated_soil_data ?c))))
