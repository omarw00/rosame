...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (have_rock_analysis ?a ?c) (available ?a) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and  (not (have_rock_analysis ?a ?c))  (not (available ?a))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
...
(:action communicate_soil_data
	...
	:precondition (and (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (available ?b) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
