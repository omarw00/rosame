...
(:action sample_soil
	...
	:precondition (and (equipped_for_rock_analysis ?a) (empty ?b) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c))
	:effect (and ))
