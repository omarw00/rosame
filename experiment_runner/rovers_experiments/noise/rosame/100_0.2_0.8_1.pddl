...
(:action communicate_image_data
	...
	:precondition (and (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?f) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
