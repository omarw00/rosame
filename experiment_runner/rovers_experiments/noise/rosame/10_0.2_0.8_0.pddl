...
(:action navigate
	...
	:precondition (and (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_soil_data ?b) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?b) (at_rock_sample ?c))
	:effect (and (at ?a ?c)))

(:action sample_soil
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_soil_analysis ?a ?c) (available ?a) (at_soil_sample ?c) (at_rock_sample ?c))
	:effect (and  (not (empty ?b))  (not (have_soil_analysis ?a ?c))  (not (at_soil_sample ?c))))
...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (empty ?b) (full ?b) (available ?a))
	:effect (and  (not (equipped_for_soil_analysis ?a))  (not (empty ?b))  (not (full ?b))  (not (available ?a))))

(:action calibrate
	:parameters (?a - camera ?b - objective ?c - rover ?d - waypoint)
	:precondition (and (at ?c ?d) (available ?c) (communicated_soil_data ?d) (at_rock_sample ?d) (visible_from ?b ?d) (on_board ?a ?c))
	:effect (and (calibrated ?a ?c)))

(:action take_image
	:parameters (?a - camera ?b - mode ?c - objective ?d - rover ?e - waypoint)
	:precondition (and (calibrated ?a ?d) (supports ?a ?b) (available ?d) (communicated_soil_data ?e) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and (have_image ?b ?c ?d) (not (calibrated ?a ?d))))

(:action communicate_soil_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?d) (available ?b) (visible ?e ?c) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?d) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (channel_free ?a))
	:effect (and (at_rock_sample ?d)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (have_soil_analysis ?d ?f) (available ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (channel_free ?a))
