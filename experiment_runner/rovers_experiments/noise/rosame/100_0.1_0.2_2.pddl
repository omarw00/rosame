...
(:action sample_soil
	...
	:effect (and  (not (equipped_for_soil_analysis ?a))  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (communicated_rock_data ?c))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
