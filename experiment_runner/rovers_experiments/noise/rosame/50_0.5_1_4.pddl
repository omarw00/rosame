...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_rock_analysis ?a) (empty ?b) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and  (not (empty ?b))  (not (have_rock_analysis ?a ?c))  (not (full ?b))  (not (at_rock_sample ?c))))
