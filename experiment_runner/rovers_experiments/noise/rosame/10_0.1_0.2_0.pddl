...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_soil_analysis ?a ?b) (available ?a) (visible ?b ?c) (visible ?c ?b) (communicated_soil_data ?b) (at_soil_sample ?c) (at_rock_sample ?b) (at_rock_sample ?c))
...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (full ?b))
	:effect (and ))

(:action calibrate
	:parameters (?a - camera ?b - objective ?c - rover ?d - waypoint)
	:precondition (and (at ?c ?d) (equipped_for_imaging ?c) (available ?c) (at_rock_sample ?d) (visible_from ?b ?d) (calibration_target ?a ?b) (on_board ?a ?c))
	:effect (and (calibrated ?a ?c)))

(:action take_image
	:parameters (?a - camera ?b - mode ?c - objective ?d - rover ?e - waypoint)
	:precondition (and (at ?d ?e) (equipped_for_imaging ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and (have_image ?b ?c ?d) (not (calibrated ?a ?d))))

(:action communicate_soil_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (have_soil_analysis ?b ?c) (available ?b) (visible ?c ?d) (visible ?c ?e) (visible ?d ?c) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
