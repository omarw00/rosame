...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (available ?a) (communicated_soil_data ?c) (at_rock_sample ?b) (at_rock_sample ?c))
...
(:action calibrate
	...
	:effect (and  (not (equipped_for_imaging ?c))  (not (have_rock_analysis ?c ?d))  (not (available ?c))  (not (calibration_target ?a ?b))))
