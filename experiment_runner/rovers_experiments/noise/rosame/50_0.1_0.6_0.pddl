...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (can_traverse ?b ?e ?c) (have_rock_analysis ?b ?e))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (have_image ?b ?c ?d) (at_soil_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
