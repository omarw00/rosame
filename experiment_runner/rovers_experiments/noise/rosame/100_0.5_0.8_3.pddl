...
(:action sample_soil
	...
	:effect (and  (not (empty ?b))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
...
(:action calibrate
	...
	:precondition (and (at ?c ?d) (equipped_for_rock_analysis ?c) (have_rock_analysis ?c ?d) (available ?c) (on_board ?a ?c))
