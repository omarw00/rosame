...
(:action sample_soil
	...
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (store_of ?a ?b))
	:effect (and (empty ?b) (not (full ?b))  (not (at_soil_sample ?c))))
...
(:action take_image
	...
	:precondition (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_rock_data ?e) (communicated_image_data ?b ?c) (at_soil_sample ?e) (at_rock_sample ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and  (not (at ?d ?e))  (not (equipped_for_soil_analysis ?d))  (not (equipped_for_rock_analysis ?d))  (not (have_rock_analysis ?d ?e))  (not (have_soil_analysis ?d ?e))  (not (calibrated ?a ?d))  (not (supports ?a ?b))  (not (available ?d))  (not (have_image ?b ?c ?d))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?e))  (not (communicated_image_data ?b ?c))  (not (at_soil_sample ?e))  (not (at_rock_sample ?e))  (not (calibration_target ?a ?c))  (not (on_board ?a ?d))))
