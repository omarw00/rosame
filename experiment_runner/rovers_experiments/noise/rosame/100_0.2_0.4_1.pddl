...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at_lander ?a ?c) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?d) (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?c ?e) (visible ?e ?c) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?d) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?c) (at_rock_sample ?e) (channel_free ?a))
	:effect (and (at ?b ?d) (at ?b ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (communicated_rock_data ?e) (at_soil_sample ?e) (at_rock_sample ?d) (not (at ?b ?c))  (not (at_lander ?a ?c))  (not (at_lander ?a ?d))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?d))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?c))  (not (have_soil_analysis ?b ?d))  (not (have_soil_analysis ?b ?e))  (not (available ?b))  (not (visible ?c ?d))  (not (visible ?c ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?c))  (not (communicated_soil_data ?d))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (at_soil_sample ?c))  (not (at_soil_sample ?d))  (not (at_rock_sample ?c))  (not (at_rock_sample ?e))  (not (channel_free ?a))))
