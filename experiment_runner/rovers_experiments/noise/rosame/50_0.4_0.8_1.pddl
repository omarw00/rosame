...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (available ?a) (at_rock_sample ?b) (at_rock_sample ?c))
...
(:action calibrate
	...
	:precondition (and (equipped_for_rock_analysis ?c) (available ?c) (at_rock_sample ?d) (visible_from ?b ?d) (calibration_target ?a ?b) (on_board ?a ?c))
	:effect (and (calibrated ?a ?c)))

(:action take_image
	:parameters (?a - camera ?b - mode ?c - objective ?d - rover ?e - waypoint)
	:precondition (and (equipped_for_rock_analysis ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (have_image ?b ?c ?d) (communicated_image_data ?b ?c) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and  (not (calibrated ?a ?d))))

(:action communicate_soil_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (available ?b) (communicated_soil_data ?e) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (available ?d) (have_image ?b ?c ?d) (communicated_soil_data ?f) (communicated_image_data ?b ?c) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
