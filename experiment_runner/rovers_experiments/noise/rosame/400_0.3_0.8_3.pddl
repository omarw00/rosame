...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_rock_data ?c))
	:effect (and (equipped_for_imaging ?a) (have_soil_analysis ?a ?c) (full ?b) (communicated_soil_data ?c) (at_soil_sample ?c) (at_rock_sample ?c)))
...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?e) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (equipped_for_rock_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
