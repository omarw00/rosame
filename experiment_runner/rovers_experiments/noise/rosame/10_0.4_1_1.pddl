...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (empty ?b) (full ?b) (communicated_rock_data ?c) (at_rock_sample ?c))
	:effect (and ))
...
(:action communicate_soil_data
	...
	:precondition (and (can_traverse ?b ?c ?d) (have_soil_analysis ?b ?e) (visible ?c ?e) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?d) (at_rock_sample ?c))
	:effect (and ))
