...
(:action take_image
	...
	:precondition (and )
	:effect (and (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (available ?d) (have_image ?b ?c ?d) (communicated_image_data ?b ?c) (at_rock_sample ?e) (visible_from ?c ?e) (calibration_target ?a ?c) (on_board ?a ?d)))
