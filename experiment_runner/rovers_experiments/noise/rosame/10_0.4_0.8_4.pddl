...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and )
	:effect (and (at_lander ?a ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (visible ?c ?d) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_rock_data ?e) (at_rock_sample ?e)))
