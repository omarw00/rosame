...
(:action calibrate
	...
	:precondition (and (have_rock_analysis ?c ?d) (at_soil_sample ?d))
	:effect (and (at ?c ?d) (equipped_for_soil_analysis ?c) (equipped_for_rock_analysis ?c) (equipped_for_imaging ?c) (have_soil_analysis ?c ?d) (calibrated ?a ?c) (available ?c) (communicated_soil_data ?d) (communicated_rock_data ?d) (at_rock_sample ?d) (visible_from ?b ?d) (calibration_target ?a ?b) (on_board ?a ?c) (not (have_rock_analysis ?c ?d))  (not (at_soil_sample ?d))))
