...
(:action sample_soil
	...
	:precondition (and (equipped_for_rock_analysis ?a) (available ?a) (communicated_soil_data ?c) (store_of ?a ?b))
	:effect (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (not (communicated_soil_data ?c))))
