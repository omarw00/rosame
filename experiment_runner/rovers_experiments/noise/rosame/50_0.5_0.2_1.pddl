...
(:action sample_soil
	...
	:precondition (and )
	:effect (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_soil_analysis ?a ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (store_of ?a ?b)))

(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (empty ?b) (full ?b) (communicated_rock_data ?c))
	:effect (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b) (not (empty ?b))  (not (full ?b))  (not (communicated_rock_data ?c))))

(:action drop
	:parameters (?a - rover ?b - store)
	:precondition (and (equipped_for_soil_analysis ?a) (available ?a))
	:effect (and (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (full ?b) (store_of ?a ?b)))
