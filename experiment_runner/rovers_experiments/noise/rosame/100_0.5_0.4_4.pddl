...
(:action sample_rock
	...
	:effect (and  (not (at ?a ?c))  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (full ?b))  (not (available ?a))  (not (communicated_rock_data ?c))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
