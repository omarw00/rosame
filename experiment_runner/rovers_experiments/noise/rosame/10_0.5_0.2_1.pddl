...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (full ?b) (available ?a) (at_soil_sample ?c))
	:effect (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_rock_sample ?c) (store_of ?a ?b) (not (full ?b))  (not (available ?a))  (not (at_soil_sample ?c))))
