...
(:action sample_soil
	...
	:effect (and  (not (at ?a ?c))  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (full ?b))  (not (available ?a))  (not (communicated_soil_data ?c))  (not (communicated_rock_data ?c))  (not (at_soil_sample ?c))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
...
(:action take_image
	...
	:precondition (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (communicated_soil_data ?e) (communicated_image_data ?b ?c) (visible_from ?c ?e) (on_board ?a ?d))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
