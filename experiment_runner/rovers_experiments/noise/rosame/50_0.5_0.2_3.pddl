...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (empty ?b) (full ?b) (communicated_soil_data ?c) (at_rock_sample ?c))
	:effect (and  (not (at ?a ?c))  (not (equipped_for_soil_analysis ?a))  (not (empty ?b))  (not (full ?b))  (not (communicated_soil_data ?c))  (not (at_rock_sample ?c))))
