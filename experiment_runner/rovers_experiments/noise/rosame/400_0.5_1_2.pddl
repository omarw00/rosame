...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c))
	:effect (and (at ?a ?c) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (have_soil_analysis ?a ?c) (available ?a) (communicated_soil_data ?c) (store_of ?a ?b)))
...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (available ?b) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
...
(:action communicate_image_data
	...
	:precondition (and (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (available ?d) (communicated_image_data ?b ?c) (at_soil_sample ?f) (at_rock_sample ?f) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
