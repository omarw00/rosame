...
(:action sample_soil
	...
	:effect (and (have_soil_analysis ?a ?c) (at_rock_sample ?c) (not (at_soil_sample ?c))))
...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?e) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?d) (equipped_for_imaging ?b) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?e) (visible ?c ?e) (visible ?d ?c) (visible ?d ?e) (visible ?e ?c) (at_soil_sample ?e))
	:effect (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?c) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (available ?b) (visible ?c ?d) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a) (not (at ?b ?e))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?e))  (not (visible ?c ?e))  (not (visible ?d ?c))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (at_soil_sample ?e))))
