...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and  (not (equipped_for_rock_analysis ?a))  (not (full ?b))  (not (communicated_soil_data ?c))  (not (at_rock_sample ?c))))
