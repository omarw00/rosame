...
(:action navigate
	...
	:precondition (and (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (available ?a) (communicated_soil_data ?b) (communicated_soil_data ?c) (communicated_rock_data ?c) (at_soil_sample ?b) (at_soil_sample ?c))
	:effect (and ))
...
(:action communicate_soil_data
	...
	:effect (and (can_traverse ?b ?c ?e) (not (can_traverse ?b ?d ?c))  (not (communicated_soil_data ?c))  (not (communicated_rock_data ?e))))
