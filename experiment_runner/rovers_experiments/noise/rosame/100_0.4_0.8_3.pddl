...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (at_soil_sample ?c) (store_of ?a ?b))
	:effect (and  (not (at ?a ?c))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (have_soil_analysis ?a ?c))  (not (full ?b))  (not (available ?a))  (not (at_soil_sample ?c))  (not (store_of ?a ?b))))
