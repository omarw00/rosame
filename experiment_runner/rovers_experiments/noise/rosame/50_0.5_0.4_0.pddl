...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?d))  (not (at_lander ?a ?d))  (not (equipped_for_rock_analysis ?b))  (not (have_rock_analysis ?b ?c))  (not (have_soil_analysis ?b ?d))  (not (visible ?c ?d))  (not (visible ?c ?e))  (not (visible ?e ?d))  (not (communicated_soil_data ?d))))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_image_data ?b ?c) (at_soil_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and ))
