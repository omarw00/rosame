...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and )
	:effect (and (equipped_for_rock_analysis ?a) (empty ?b) (full ?b)))
