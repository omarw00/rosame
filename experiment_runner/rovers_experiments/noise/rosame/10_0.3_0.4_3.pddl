...
(:action take_image
	...
	:precondition (and (at ?d ?e) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (calibrated ?a ?d) (available ?d) (communicated_rock_data ?e) (communicated_image_data ?b ?c) (at_soil_sample ?e) (at_rock_sample ?e) (calibration_target ?a ?c) (on_board ?a ?d))
	:effect (and (equipped_for_rock_analysis ?d) (supports ?a ?b) (have_image ?b ?c ?d) (communicated_soil_data ?e) (visible_from ?c ?e)))
