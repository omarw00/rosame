...
(:action navigate
	...
	:precondition (and (at ?a ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (available ?a) (at_rock_sample ?b) (at_rock_sample ?c))
...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (have_rock_analysis ?a ?c) (communicated_soil_data ?c) (at_soil_sample ?c))
	:effect (and (equipped_for_imaging ?a) (empty ?b) (have_soil_analysis ?a ?c) (available ?a) (at_rock_sample ?c)))
