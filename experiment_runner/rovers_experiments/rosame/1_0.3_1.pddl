...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?c) (at ?b ?e) (at_lander ?a ?c) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (available ?b) (visible ?c ?d) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?d) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (channel_free ?a))
	:effect (and (at ?b ?d) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (have_soil_analysis ?b ?e) (visible ?c ?e) (visible ?d ?c) (communicated_soil_data ?c) (communicated_soil_data ?e) (communicated_rock_data ?c) (at_rock_sample ?d) (at_rock_sample ?e)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?e) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (have_soil_analysis ?d ?e) (have_soil_analysis ?d ?f) (available ?d) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and  (not (at ?d ?e))  (not (at ?d ?f))  (not (at_lander ?a ?e))  (not (can_traverse ?d ?e ?f))  (not (can_traverse ?d ?f ?e))  (not (equipped_for_soil_analysis ?d))  (not (equipped_for_rock_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_rock_analysis ?d ?e))  (not (have_rock_analysis ?d ?f))  (not (have_soil_analysis ?d ?e))  (not (have_soil_analysis ?d ?f))  (not (available ?d))  (not (visible ?f ?e))  (not (have_image ?b ?c ?d))  (not (communicated_rock_data ?f))  (not (communicated_image_data ?b ?c))  (not (at_soil_sample ?e))  (not (at_soil_sample ?f))  (not (at_rock_sample ?e))  (not (at_rock_sample ?f))  (not (visible_from ?c ?e))  (not (visible_from ?c ?f))  (not (channel_free ?a))))
