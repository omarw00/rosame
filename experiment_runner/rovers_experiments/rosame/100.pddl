...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?d) (have_soil_analysis ?b ?c) (available ?b) (at_soil_sample ?e) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and (communicated_soil_data ?c)))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and )
	:effect (and (at ?b ?c) (at_lander ?a ?c) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?d) (visible ?c ?d) (visible ?d ?c) (visible ?e ?c) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?d) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c)))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (available ?d) (at_soil_sample ?e) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
