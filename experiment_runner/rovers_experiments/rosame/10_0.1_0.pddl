...
(:action sample_soil
	...
	:precondition (and (at ?a ?c) (empty ?b) (available ?a) (at_soil_sample ?c))
...
(:action communicate_soil_data
	...
	:precondition (and (at_lander ?a ?c) (at_lander ?a ?d) (can_traverse ?b ?c ?d) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (have_soil_analysis ?b ?c) (available ?b) (visible ?c ?e) (visible ?e ?c) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?d))
	:effect (and  (not (at_lander ?a ?c))  (not (at_lander ?a ?d))  (not (can_traverse ?b ?c ?d))  (not (can_traverse ?b ?e ?c))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_soil_analysis ?b))  (not (have_rock_analysis ?b ?c))  (not (have_soil_analysis ?b ?c))  (not (available ?b))  (not (visible ?c ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (communicated_rock_data ?e))  (not (at_soil_sample ?c))  (not (at_soil_sample ?d))  (not (at_soil_sample ?e))  (not (at_rock_sample ?d))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (have_rock_analysis ?d ?e) (available ?d) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?f) (channel_free ?a))
	:effect (and ))
