...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (available ?a) (store_of ?a ?b))
	:effect (and (full ?b) (not (at ?a ?c))  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (have_rock_analysis ?a ?c))  (not (have_soil_analysis ?a ?c))  (not (available ?a))  (not (store_of ?a ?b))))
