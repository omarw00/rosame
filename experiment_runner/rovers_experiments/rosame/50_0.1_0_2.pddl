...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_soil_analysis ?a) (have_soil_analysis ?a ?c) (communicated_rock_data ?c) (store_of ?a ?b))
	:effect (and ))
