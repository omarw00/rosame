...
(:action communicate_image_data
	...
	:precondition (and (at_lander ?a ?e) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_soil_analysis ?d ?e) (have_soil_analysis ?d ?f) (communicated_image_data ?b ?c) (at_soil_sample ?f) (at_rock_sample ?e) (visible_from ?c ?e) (visible_from ?c ?f))
	:effect (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (available ?d) (visible ?e ?f) (visible ?f ?e) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (at_soil_sample ?e) (at_rock_sample ?f) (channel_free ?a) (not (at_lander ?a ?e))  (not (equipped_for_rock_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_soil_analysis ?d ?e))  (not (have_soil_analysis ?d ?f))  (not (communicated_image_data ?b ?c))  (not (at_soil_sample ?f))  (not (at_rock_sample ?e))  (not (visible_from ?c ?e))  (not (visible_from ?c ?f))))
