...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?c) (have_soil_analysis ?b ?e) (communicated_soil_data ?c) (at_rock_sample ?c))
	:effect (and ))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at ?b ?e) (at_lander ?a ?c) (at_lander ?a ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?c) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?d ?e) (visible ?e ?c) (communicated_soil_data ?d) (at_soil_sample ?d) (at_rock_sample ?c) (channel_free ?a))
	:effect (and  (not (at ?b ?c))  (not (at ?b ?e))  (not (at_lander ?a ?c))  (not (at_lander ?a ?d))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?c))  (not (equipped_for_soil_analysis ?b))  (not (have_rock_analysis ?b ?c))  (not (have_rock_analysis ?b ?d))  (not (have_soil_analysis ?b ?e))  (not (available ?b))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?d))  (not (at_soil_sample ?d))  (not (at_rock_sample ?c))  (not (channel_free ?a))))
