...
(:action navigate
	...
	:precondition (and (equipped_for_imaging ?a) (available ?a) (visible ?b ?c) (communicated_soil_data ?c) (at_soil_sample ?b) (at_soil_sample ?c) (at_rock_sample ?b))
	:effect (and (at ?a ?c)))

(:action sample_soil
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (available ?a) (at_soil_sample ?c) (at_rock_sample ?c))
...
(:action take_image
	...
	:precondition (and (at ?d ?e) (equipped_for_imaging ?d) (calibrated ?a ?d) (available ?d) (communicated_soil_data ?e) (at_soil_sample ?e) (calibration_target ?a ?c))
...
(:action communicate_soil_data
	...
	:effect (and  (not (can_traverse ?b ?d ?e))))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and )
	:effect (and (at ?b ?d) (at ?b ?e) (at_lander ?a ?d) (can_traverse ?b ?c ?d) (communicated_soil_data ?c) (at_rock_sample ?c)))
