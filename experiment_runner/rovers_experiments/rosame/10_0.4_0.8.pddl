...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (equipped_for_imaging ?a) (empty ?b) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c) (store_of ?a ?b))
	:effect (and (at ?a ?c) (have_rock_analysis ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (communicated_rock_data ?c) (at_rock_sample ?c) (not (empty ?b))))
