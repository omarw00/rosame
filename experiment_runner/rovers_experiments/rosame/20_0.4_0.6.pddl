...
(:action communicate_soil_data
	...
	:effect (and  (not (at_lander ?a ?c))  (not (communicated_soil_data ?c))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (have_soil_analysis ?d ?e) (have_soil_analysis ?d ?f) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?f) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and (at ?d ?f) (available ?d) (communicated_rock_data ?e) (communicated_image_data ?b ?c) (at_soil_sample ?e)))
