...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?d) (have_soil_analysis ?b ?c) (available ?b) (communicated_soil_data ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (have_rock_analysis ?b ?c) (available ?b) (communicated_rock_data ?c) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
