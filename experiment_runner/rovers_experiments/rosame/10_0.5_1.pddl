...
(:action drop
	...
	:effect (and  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (full ?b))  (not (available ?a))))
...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?d) (at_lander ?a ?d) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (equipped_for_rock_analysis ?b) (have_soil_analysis ?b ?c) (visible ?e ?c) (visible ?e ?d) (communicated_rock_data ?d) (at_soil_sample ?c) (at_soil_sample ?d))
	:effect (and ))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at_lander ?a ?e) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?f) (available ?d) (visible ?e ?f) (communicated_soil_data ?e) (communicated_image_data ?b ?c) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?f) (channel_free ?a))
	:effect (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?f) (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (have_soil_analysis ?d ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (at_soil_sample ?e) (at_soil_sample ?f) (visible_from ?c ?e) (not (at_lander ?a ?e))  (not (can_traverse ?d ?e ?f))  (not (can_traverse ?d ?f ?e))  (not (equipped_for_soil_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_rock_analysis ?d ?f))  (not (available ?d))  (not (visible ?e ?f))  (not (communicated_soil_data ?e))  (not (communicated_image_data ?b ?c))  (not (at_rock_sample ?e))  (not (at_rock_sample ?f))  (not (visible_from ?c ?f))  (not (channel_free ?a))))
