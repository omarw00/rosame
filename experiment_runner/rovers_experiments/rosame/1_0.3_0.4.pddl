...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?f) (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_soil_analysis ?d ?e) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_rock_data ?e) (communicated_rock_data ?f) (at_soil_sample ?e) (at_soil_sample ?f))
	:effect (and (at ?d ?e) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (equipped_for_soil_analysis ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (have_soil_analysis ?d ?f) (available ?d) (visible ?e ?f) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_image_data ?b ?c) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a) (not (at ?d ?f))  (not (can_traverse ?d ?f ?e))  (not (equipped_for_rock_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_soil_analysis ?d ?e))  (not (visible ?f ?e))  (not (have_image ?b ?c ?d))  (not (communicated_rock_data ?e))  (not (communicated_rock_data ?f))  (not (at_soil_sample ?e))  (not (at_soil_sample ?f))))
