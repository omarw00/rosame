...
(:action sample_soil
	...
	:effect (and  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (empty ?b))  (not (have_rock_analysis ?a ?c))  (not (full ?b))  (not (communicated_soil_data ?c))  (not (at_soil_sample ?c))  (not (store_of ?a ?b))))
...
(:action drop
	...
	:effect (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (full ?b) (available ?a) (store_of ?a ?b)))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_soil_analysis ?d ?f) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (visible_from ?c ?e) (channel_free ?a))
	:effect (and ))
