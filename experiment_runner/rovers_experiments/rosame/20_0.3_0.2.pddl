...
(:action communicate_soil_data
	...
	:precondition (and (at_lander ?a ?d) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?d) (equipped_for_imaging ?b) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?d) (available ?b) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?c) (communicated_rock_data ?c) (communicated_rock_data ?d) (at_rock_sample ?c))
	:effect (and  (not (at_lander ?a ?d))  (not (can_traverse ?b ?c ?d))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?d))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?d))  (not (available ?b))  (not (visible ?d ?e))  (not (visible ?e ?d))  (not (communicated_soil_data ?c))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (at_rock_sample ?c))))
