...
(:action communicate_soil_data
	...
	:precondition (and (can_traverse ?b ?e ?d) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e))
	:effect (and ))
...
(:action communicate_image_data
	...
	:precondition (and )
	:effect (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?e) (can_traverse ?d ?e ?f) (equipped_for_soil_analysis ?d) (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (available ?d) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_rock_data ?f) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?f)))
