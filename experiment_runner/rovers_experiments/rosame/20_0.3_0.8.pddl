...
(:action navigate
	...
	:precondition (and (at ?a ?b) (equipped_for_imaging ?a) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?b) (at_soil_sample ?c))
...
(:action communicate_soil_data
	...
	:precondition (and )
	:effect (and (at ?b ?d) (at ?b ?e) (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (equipped_for_rock_analysis ?b) (have_rock_analysis ?b ?e) (visible ?e ?d)))
