...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_imaging ?a) (empty ?b) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c) (at_rock_sample ?c) (store_of ?a ?b))
	:effect (and (have_rock_analysis ?a ?c) (full ?b) (not (empty ?b))  (not (at_rock_sample ?c))  (not (store_of ?a ?b))))
...
(:action communicate_soil_data
	...
	:precondition (and )
	:effect (and (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?e)))
