...
(:action sample_rock
	...
	:effect (and (have_rock_analysis ?a ?c) (full ?b) (not (equipped_for_imaging ?a))  (not (empty ?b))  (not (at_rock_sample ?c))))
...
(:action communicate_rock_data
	...
	:effect (and (at ?b ?d) (have_soil_analysis ?b ?e) (communicated_soil_data ?e) (not (at_lander ?a ?e))))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (available ?d) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
