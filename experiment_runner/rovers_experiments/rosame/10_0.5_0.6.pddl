...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (empty ?b) (available ?a) (communicated_soil_data ?c) (at_soil_sample ?c) (at_rock_sample ?c))
	:effect (and (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (full ?b) (not (empty ?b))  (not (at_rock_sample ?c))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at ?d ?f) (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (have_soil_analysis ?d ?f) (available ?d) (visible ?e ?f) (visible ?f ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (equipped_for_soil_analysis ?d) (have_soil_analysis ?d ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (at_soil_sample ?e) (not (at ?d ?e))  (not (at ?d ?f))  (not (can_traverse ?d ?f ?e))  (not (equipped_for_rock_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_rock_analysis ?d ?e))  (not (have_rock_analysis ?d ?f))  (not (have_soil_analysis ?d ?f))  (not (available ?d))  (not (visible ?e ?f))  (not (visible ?f ?e))  (not (communicated_soil_data ?f))  (not (communicated_rock_data ?e))  (not (communicated_rock_data ?f))  (not (communicated_image_data ?b ?c))  (not (at_soil_sample ?f))  (not (at_rock_sample ?e))  (not (at_rock_sample ?f))  (not (visible_from ?c ?e))  (not (visible_from ?c ?f))  (not (channel_free ?a))))
