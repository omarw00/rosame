...
(:action communicate_soil_data
	...
	:precondition (and )
	:effect (and (at ?b ?d) (communicated_soil_data ?c) (at_soil_sample ?e) (at_rock_sample ?c) (channel_free ?a)))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?d) (have_rock_analysis ?b ?c) (available ?b) (communicated_soil_data ?d) (communicated_rock_data ?c) (at_soil_sample ?c) (at_soil_sample ?e) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (available ?d) (at_rock_sample ?f) (channel_free ?a))
	:effect (and ))
