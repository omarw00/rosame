...
(:action communicate_soil_data
	...
	:precondition (and (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (visible ?c ?e) (communicated_rock_data ?c) (at_rock_sample ?c))
	:effect (and (at ?b ?c) (at ?b ?d) (at ?b ?e) (at_lander ?a ?c) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a) (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (visible ?c ?e))  (not (communicated_rock_data ?c))  (not (at_rock_sample ?c))))
...
(:action communicate_image_data
	...
	:precondition (and (visible_from ?c ?f))
