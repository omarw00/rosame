...
(:action drop
	...
	:effect (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (empty ?b) (full ?b) (store_of ?a ?b) (not (equipped_for_imaging ?a))  (not (available ?a))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (channel_free ?a))
	:effect (and ))
