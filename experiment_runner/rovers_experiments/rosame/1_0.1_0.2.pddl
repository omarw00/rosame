...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?e) (at_lander ?a ?d) (can_traverse ?b ?e ?c) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_rock_data ?d) (at_soil_sample ?e) (at_rock_sample ?c) (channel_free ?a))
	:effect (and (at ?b ?c) (at ?b ?d) (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (have_rock_analysis ?b ?d) (visible ?c ?e) (visible ?e ?c) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?d) (at_rock_sample ?e) (not (at ?b ?e))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (have_soil_analysis ?b ?c))  (not (have_soil_analysis ?b ?d))  (not (visible ?d ?c))  (not (communicated_rock_data ?d))))
