...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?e) (can_traverse ?b ?c ?e) (have_soil_analysis ?b ?c) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d))
	:effect (and  (not (at ?b ?e))  (not (can_traverse ?b ?c ?e))  (not (have_soil_analysis ?b ?c))  (not (at_soil_sample ?e))  (not (at_rock_sample ?c))  (not (at_rock_sample ?d))))
