...
(:action communicate_soil_data
	...
	:precondition (and )
	:effect (and (equipped_for_rock_analysis ?b)))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at ?b ?e) (have_soil_analysis ?b ?d) (visible ?d ?c) (channel_free ?a))
	:effect (and  (not (at ?b ?c))  (not (at ?b ?e))  (not (have_soil_analysis ?b ?d))  (not (visible ?d ?c))  (not (channel_free ?a))))
