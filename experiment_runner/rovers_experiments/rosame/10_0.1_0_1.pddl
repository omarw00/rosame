...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_soil_analysis ?a ?c) (available ?a) (visible ?b ?c) (visible ?c ?b) (at_soil_sample ?b) (at_rock_sample ?b) (at_rock_sample ?c))
...
(:action calibrate
	...
	:precondition (and (at ?c ?d) (equipped_for_rock_analysis ?c) (equipped_for_imaging ?c) (available ?c) (at_soil_sample ?d) (visible_from ?b ?d) (calibration_target ?a ?b) (on_board ?a ?c))
	:effect (and (calibrated ?a ?c)))

(:action take_image
	:parameters (?a - camera ?b - mode ?c - objective ?d - rover ?e - waypoint)
	:precondition (and (at ?d ?e) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (calibrated ?a ?d) (supports ?a ?b) (available ?d) (at_soil_sample ?e) (visible_from ?c ?e) (on_board ?a ?d))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at_lander ?a ?f) (equipped_for_rock_analysis ?d) (equipped_for_imaging ?d) (have_rock_analysis ?d ?e) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (at_soil_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (channel_free ?a))
