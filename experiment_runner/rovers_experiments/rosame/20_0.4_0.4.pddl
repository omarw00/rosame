...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and )
	:effect (and (at ?b ?c) (at ?b ?d) (at ?b ?e) (at_lander ?a ?c) (at_lander ?a ?d) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?c ?e) (visible ?d ?c) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_rock_data ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?a)))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (can_traverse ?d ?f ?e) (have_rock_analysis ?d ?e) (have_soil_analysis ?d ?e) (available ?d) (visible ?e ?f) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (at_soil_sample ?e) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?a))
	:effect (and  (not (at ?d ?e))  (not (at_lander ?a ?e))  (not (at_lander ?a ?f))  (not (can_traverse ?d ?e ?f))  (not (can_traverse ?d ?f ?e))  (not (have_rock_analysis ?d ?e))  (not (have_soil_analysis ?d ?e))  (not (available ?d))  (not (visible ?e ?f))  (not (communicated_soil_data ?e))  (not (communicated_soil_data ?f))  (not (communicated_rock_data ?e))  (not (communicated_rock_data ?f))  (not (at_soil_sample ?e))  (not (at_rock_sample ?e))  (not (at_rock_sample ?f))  (not (visible_from ?c ?e))  (not (visible_from ?c ?f))  (not (channel_free ?a))))
