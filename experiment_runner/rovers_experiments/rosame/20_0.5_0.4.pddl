...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (have_rock_analysis ?d ?e) (communicated_rock_data ?f))
	:effect (and  (not (at ?d ?e))  (not (have_rock_analysis ?d ?e))  (not (communicated_rock_data ?f))))
