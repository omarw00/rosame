...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at_lander ?a ?c) (at_lander ?a ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (equipped_for_rock_analysis ?b) (equipped_for_imaging ?b) (visible ?c ?d) (visible ?c ?e) (visible ?e ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?e) (at_rock_sample ?e))
	:effect (and  (not (at ?b ?c))  (not (at_lander ?a ?c))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?c ?d))  (not (can_traverse ?b ?d ?c))  (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (visible ?c ?d))  (not (visible ?c ?e))  (not (visible ?e ?c))  (not (communicated_rock_data ?d))  (not (communicated_rock_data ?e))  (not (at_soil_sample ?c))  (not (at_soil_sample ?e))  (not (at_rock_sample ?e))))
...
(:action communicate_image_data
	...
	:effect (and  (not (at_lander ?a ?f))  (not (can_traverse ?d ?e ?f))  (not (can_traverse ?d ?f ?e))  (not (have_soil_analysis ?d ?e))  (not (available ?d))  (not (visible ?f ?e))  (not (have_image ?b ?c ?d))  (not (communicated_rock_data ?f))  (not (at_soil_sample ?f))  (not (visible_from ?c ?f))))
