...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (equipped_for_imaging ?a) (empty ?b) (available ?a) (at_soil_sample ?c) (at_rock_sample ?c))
...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (at ?b ?d) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (available ?b) (visible ?c ?d) (communicated_soil_data ?d) (communicated_rock_data ?c) (at_soil_sample ?c) (at_soil_sample ?d) (at_rock_sample ?d) (channel_free ?a))
	:effect (and ))

(:action communicate_image_data
	:parameters (?a - lander ?b - mode ?c - objective ?d - rover ?e - waypoint ?f - waypoint)
	:precondition (and (at ?d ?e) (equipped_for_imaging ?d) (available ?d) (communicated_soil_data ?f) (at_soil_sample ?f) (at_rock_sample ?e) (channel_free ?a))
	:effect (and ))
