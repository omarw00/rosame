...
(:action sample_rock
	:parameters (?a - rover ?b - store ?c - waypoint)
	:precondition (and (at ?a ?c) (empty ?b) (at_rock_sample ?c))
...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?e) (at_lander ?a ?e) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (visible ?e ?d))
	:effect (and  (not (at ?b ?e))  (not (at_lander ?a ?e))  (not (equipped_for_soil_analysis ?b))  (not (equipped_for_imaging ?b))  (not (visible ?e ?d))))
