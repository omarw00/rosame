...
(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and )
	:effect (and (at ?b ?e) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_rock_analysis ?b) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?e) (visible ?d ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?d) (at_soil_sample ?e) (at_rock_sample ?d)))
