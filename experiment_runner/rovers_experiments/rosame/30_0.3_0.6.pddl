...
(:action communicate_soil_data
	...
	:precondition (and (at_lander ?a ?d) (can_traverse ?b ?e ?c) (equipped_for_imaging ?b) (have_rock_analysis ?b ?c) (have_soil_analysis ?b ?d) (communicated_soil_data ?c) (communicated_rock_data ?d) (at_rock_sample ?c) (at_rock_sample ?d))
	:effect (and  (not (at_lander ?a ?d))  (not (can_traverse ?b ?e ?c))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?c))  (not (have_soil_analysis ?b ?d))  (not (communicated_soil_data ?c))  (not (communicated_rock_data ?d))  (not (at_rock_sample ?c))  (not (at_rock_sample ?d))))

(:action communicate_rock_data
	:parameters (?a - lander ?b - rover ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?b ?c) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (equipped_for_soil_analysis ?b) (have_rock_analysis ?b ?d) (have_rock_analysis ?b ?e) (visible ?c ?d) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?c) (communicated_rock_data ?d) (at_soil_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e))
	:effect (and ))
