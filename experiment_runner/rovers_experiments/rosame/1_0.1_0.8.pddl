...
(:action sample_soil
	...
	:effect (and (at ?a ?c) (have_soil_analysis ?a ?c) (full ?b) (available ?a) (at_rock_sample ?c) (not (empty ?b))  (not (at_soil_sample ?c))))
