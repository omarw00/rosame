...
(:action calibrate
	...
	:precondition (and (at ?c ?d) (communicated_rock_data ?d) (visible_from ?b ?d))
...
(:action communicate_image_data
	...
	:effect (and  (not (visible ?f ?e))  (not (communicated_rock_data ?f))))
