...
(:action communicate_soil_data
	...
	:precondition (and (have_rock_analysis ?b ?c))
...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?b ?c))  (not (at ?b ?d))  (not (at ?b ?e))  (not (at_lander ?a ?c))  (not (at_lander ?a ?d))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?c))  (not (can_traverse ?b ?e ?d))  (not (equipped_for_soil_analysis ?b))  (not (equipped_for_rock_analysis ?b))  (not (equipped_for_imaging ?b))  (not (have_rock_analysis ?b ?c))  (not (have_rock_analysis ?b ?d))  (not (have_soil_analysis ?b ?c))  (not (have_soil_analysis ?b ?d))  (not (have_soil_analysis ?b ?e))  (not (available ?b))  (not (visible ?c ?d))  (not (visible ?d ?c))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?c))  (not (communicated_soil_data ?d))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (at_soil_sample ?c))  (not (at_soil_sample ?d))  (not (at_rock_sample ?c))  (not (at_rock_sample ?d))  (not (at_rock_sample ?e))  (not (channel_free ?a))))
