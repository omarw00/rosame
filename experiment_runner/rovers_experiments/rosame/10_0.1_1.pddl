...
(:action drop
	...
	:precondition (and )
	:effect (and (equipped_for_rock_analysis ?a) (available ?a)))
...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?e) (at_lander ?a ?e) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?c) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?c) (equipped_for_rock_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?e) (have_soil_analysis ?b ?d) (visible ?c ?e) (visible ?d ?e) (visible ?e ?c) (communicated_soil_data ?d) (communicated_rock_data ?c) (communicated_rock_data ?d) (at_soil_sample ?e) (at_rock_sample ?c) (channel_free ?a))
	:effect (and  (not (at ?b ?e))  (not (at_lander ?a ?e))  (not (can_traverse ?b ?c ?e))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?d ?e))  (not (can_traverse ?b ?e ?c))  (not (equipped_for_rock_analysis ?b))  (not (have_rock_analysis ?b ?c))  (not (have_rock_analysis ?b ?e))  (not (have_soil_analysis ?b ?d))  (not (visible ?c ?e))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (communicated_soil_data ?d))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (at_soil_sample ?e))  (not (at_rock_sample ?c))  (not (channel_free ?a))))
...
(:action communicate_image_data
	...
	:precondition (and (at ?d ?e) (at ?d ?f) (at_lander ?a ?e) (at_lander ?a ?f) (can_traverse ?d ?e ?f) (equipped_for_soil_analysis ?d) (equipped_for_imaging ?d) (have_soil_analysis ?d ?e) (available ?d) (visible ?e ?f) (visible ?f ?e) (have_image ?b ?c ?d) (communicated_soil_data ?e) (communicated_soil_data ?f) (communicated_rock_data ?e) (communicated_rock_data ?f) (communicated_image_data ?b ?c) (at_soil_sample ?e) (at_soil_sample ?f) (at_rock_sample ?e) (at_rock_sample ?f) (visible_from ?c ?f) (channel_free ?a))
	:effect (and (can_traverse ?d ?f ?e) (equipped_for_rock_analysis ?d) (have_rock_analysis ?d ?e) (have_rock_analysis ?d ?f) (have_soil_analysis ?d ?f) (visible_from ?c ?e) (not (at ?d ?e))  (not (at ?d ?f))  (not (at_lander ?a ?e))  (not (at_lander ?a ?f))  (not (can_traverse ?d ?e ?f))  (not (equipped_for_soil_analysis ?d))  (not (equipped_for_imaging ?d))  (not (have_soil_analysis ?d ?e))  (not (available ?d))  (not (visible ?e ?f))  (not (visible ?f ?e))  (not (have_image ?b ?c ?d))  (not (communicated_soil_data ?e))  (not (communicated_soil_data ?f))  (not (communicated_rock_data ?e))  (not (communicated_rock_data ?f))  (not (communicated_image_data ?b ?c))  (not (at_soil_sample ?e))  (not (at_soil_sample ?f))  (not (at_rock_sample ?e))  (not (at_rock_sample ?f))  (not (visible_from ?c ?f))  (not (channel_free ?a))))
