...
(:action communicate_soil_data
	...
	:precondition (and (at ?b ?d) (at ?b ?e) (can_traverse ?b ?c ?d) (can_traverse ?b ?d ?c) (can_traverse ?b ?e ?c) (equipped_for_rock_analysis ?b) (have_rock_analysis ?b ?c) (have_rock_analysis ?b ?e) (visible ?c ?e) (visible ?d ?e) (communicated_soil_data ?e) (at_soil_sample ?d))
	:effect (and (at_lander ?a ?c) (at_lander ?a ?d) (can_traverse ?b ?c ?e) (can_traverse ?b ?d ?e) (can_traverse ?b ?e ?d) (equipped_for_soil_analysis ?b) (equipped_for_imaging ?b) (have_rock_analysis ?b ?d) (have_soil_analysis ?b ?c) (have_soil_analysis ?b ?d) (have_soil_analysis ?b ?e) (available ?b) (visible ?c ?d) (visible ?d ?c) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_rock_data ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (channel_free ?a) (not (at ?b ?d))  (not (at ?b ?e))  (not (can_traverse ?b ?c ?d))  (not (can_traverse ?b ?d ?c))  (not (can_traverse ?b ?e ?c))  (not (equipped_for_rock_analysis ?b))  (not (have_rock_analysis ?b ?c))  (not (have_rock_analysis ?b ?e))  (not (visible ?c ?e))  (not (visible ?d ?e))  (not (communicated_soil_data ?e))  (not (at_soil_sample ?d))))
