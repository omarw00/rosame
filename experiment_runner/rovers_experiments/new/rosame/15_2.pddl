...
(:action take_image
	...
	:precondition (and (at ?a ?b) (equipped_for_imaging ?a) (calibrated ?d ?a) (supports ?d ?e) (available ?a) (at_soil_sample ?b) (at_rock_sample ?b) (visible_from ?c ?b) (calibration_target ?d ?c) (on_board ?d ?a))
	:effect (and (have_image ?a ?c ?e) (not (calibrated ?d ?a))))

(:action communicate_soil_data
	:parameters (?a - rover ?b - lander ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?a ?d) (at_lander ?b ?e) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_soil_analysis ?a ?c) (available ?a) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (at_soil_sample ?e) (channel_free ?b))
...
(:action communicate_image_data
	...
	:precondition (and (at ?a ?e) (at_lander ?b ?f) (equipped_for_imaging ?a) (available ?a) (visible ?e ?f) (visible ?f ?e) (have_image ?a ?c ?d) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?b))
