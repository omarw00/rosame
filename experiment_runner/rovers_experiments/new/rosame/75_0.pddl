...
(:action communicate_soil_data
	...
	:precondition (and (at ?a ?d) (at_lander ?b ?e) (can_traverse ?a ?c ?d) (can_traverse ?a ?d ?c) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (have_soil_analysis ?a ?c) (available ?a) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?d) (at_rock_sample ?e) (channel_free ?b))
	:effect (and (communicated_soil_data ?c)))

(:action communicate_rock_data
	:parameters (?a - rover ?b - lander ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?a ?d) (at_lander ?b ?e) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_rock_analysis ?a ?e) (have_soil_analysis ?a ?d) (available ?a) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (communicated_soil_data ?d) (communicated_rock_data ?e) (channel_free ?b))
	:effect (and (communicated_rock_data ?c)))

(:action communicate_image_data
	:parameters (?a - rover ?b - lander ?c - objective ?d - mode ?e - waypoint ?f - waypoint)
	:precondition (and (at ?a ?e) (at_lander ?b ?f) (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (available ?a) (visible ?e ?f) (visible ?f ?e) (have_image ?a ?c ?d) (visible_from ?c ?f) (channel_free ?b))
