...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (empty ?b) (full ?b) (available ?a))
	:effect (and ))
...
(:action communicate_rock_data
	...
	:effect (and  (not (at ?a ?c))  (not (at ?a ?d))  (not (at ?a ?e))  (not (at_lander ?b ?c))  (not (at_lander ?b ?d))  (not (at_lander ?b ?e))  (not (can_traverse ?a ?c ?d))  (not (can_traverse ?a ?c ?e))  (not (can_traverse ?a ?d ?c))  (not (can_traverse ?a ?e ?c))  (not (can_traverse ?a ?e ?d))  (not (equipped_for_soil_analysis ?a))  (not (equipped_for_rock_analysis ?a))  (not (equipped_for_imaging ?a))  (not (have_rock_analysis ?a ?c))  (not (have_rock_analysis ?a ?d))  (not (have_rock_analysis ?a ?e))  (not (have_soil_analysis ?a ?c))  (not (have_soil_analysis ?a ?d))  (not (visible ?c ?d))  (not (visible ?c ?e))  (not (visible ?d ?c))  (not (visible ?d ?e))  (not (visible ?e ?c))  (not (visible ?e ?d))  (not (communicated_soil_data ?c))  (not (communicated_soil_data ?d))  (not (communicated_soil_data ?e))  (not (communicated_rock_data ?c))  (not (communicated_rock_data ?d))  (not (communicated_rock_data ?e))  (not (at_soil_sample ?c))  (not (at_soil_sample ?d))  (not (at_soil_sample ?e))  (not (at_rock_sample ?d))  (not (at_rock_sample ?e))  (not (channel_free ?b))))
