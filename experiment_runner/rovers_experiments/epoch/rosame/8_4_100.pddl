...
(:action sample_soil
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (empty ?b) (at_soil_sample ?c))
...
(:action communicate_rock_data
	:parameters (?a - rover ?b - lander ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (visible ?d ?c))
	:effect (and (at ?a ?c) (at ?a ?d) (at ?a ?e) (at_lander ?b ?c) (at_lander ?b ?d) (at_lander ?b ?e) (can_traverse ?a ?c ?d) (can_traverse ?a ?c ?e) (can_traverse ?a ?d ?c) (can_traverse ?a ?d ?e) (can_traverse ?a ?e ?c) (can_traverse ?a ?e ?d) (equipped_for_soil_analysis ?a) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (have_rock_analysis ?a ?d) (have_rock_analysis ?a ?e) (have_soil_analysis ?a ?c) (have_soil_analysis ?a ?d) (have_soil_analysis ?a ?e) (available ?a) (visible ?c ?d) (visible ?c ?e) (visible ?d ?e) (visible ?e ?c) (visible ?e ?d) (communicated_soil_data ?c) (communicated_soil_data ?d) (communicated_soil_data ?e) (communicated_rock_data ?c) (communicated_rock_data ?d) (communicated_rock_data ?e) (at_soil_sample ?c) (at_soil_sample ?d) (at_soil_sample ?e) (at_rock_sample ?c) (at_rock_sample ?d) (at_rock_sample ?e) (channel_free ?b)))
