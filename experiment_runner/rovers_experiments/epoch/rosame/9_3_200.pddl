...
(:action drop
	...
	:precondition (and (equipped_for_soil_analysis ?a) (equipped_for_imaging ?a) (full ?b) (available ?a) (store_of ?b ?a))
	:effect (and (empty ?b) (not (full ?b))))

(:action calibrate
	:parameters (?a - rover ?b - camera ?c - objective ?d - waypoint)
	:precondition (and (at ?a ?d) (equipped_for_imaging ?a) (available ?a) (visible_from ?c ?d) (calibration_target ?b ?c) (on_board ?b ?a))
	:effect (and (calibrated ?b ?a)))

(:action take_image
	:parameters (?a - rover ?b - waypoint ?c - objective ?d - camera ?e - mode)
	:precondition (and (at ?a ?b) (equipped_for_imaging ?a) (calibrated ?d ?a) (supports ?d ?e) (available ?a) (visible_from ?c ?b) (calibration_target ?d ?c) (on_board ?d ?a))
...
(:action communicate_image_data
	...
	:precondition (and (at ?a ?e) (at_lander ?b ?f) (can_traverse ?a ?e ?f) (can_traverse ?a ?f ?e) (equipped_for_imaging ?a) (available ?a) (visible ?e ?f) (visible ?f ?e) (have_image ?a ?c ?d) (at_soil_sample ?f) (visible_from ?c ?e) (visible_from ?c ?f) (channel_free ?b))
