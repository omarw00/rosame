...
(:action navigate
	...
	:precondition (and (at ?a ?b) (can_traverse ?a ?b ?c) (can_traverse ?a ?c ?b) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (available ?a) (visible ?b ?c) (visible ?c ?b))
...
(:action drop
	...
	:precondition (and (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (full ?b) (available ?a) (store_of ?b ?a))
	:effect (and (empty ?b) (not (full ?b))))

(:action calibrate
	:parameters (?a - rover ?b - camera ?c - objective ?d - waypoint)
	:precondition (and (at ?a ?d) (equipped_for_imaging ?a) (available ?a) (at_soil_sample ?d) (visible_from ?c ?d) (calibration_target ?b ?c) (on_board ?b ?a))
	:effect (and (calibrated ?b ?a)))

(:action take_image
	:parameters (?a - rover ?b - waypoint ?c - objective ?d - camera ?e - mode)
	:precondition (and (at ?a ?b) (equipped_for_imaging ?a) (calibrated ?d ?a) (supports ?d ?e) (available ?a) (at_soil_sample ?b) (visible_from ?c ?b) (on_board ?d ?a))
...
(:action communicate_rock_data
	:parameters (?a - rover ?b - lander ?c - waypoint ?d - waypoint ?e - waypoint)
	:precondition (and (at ?a ?d) (at_lander ?b ?e) (can_traverse ?a ?c ?d) (can_traverse ?a ?d ?c) (equipped_for_rock_analysis ?a) (equipped_for_imaging ?a) (have_rock_analysis ?a ?c) (available ?a) (visible ?c ?d) (visible ?d ?c) (visible ?d ?e) (visible ?e ?d) (at_soil_sample ?e) (channel_free ?b))
	:effect (and (communicated_rock_data ?c)))

(:action communicate_image_data
	:parameters (?a - rover ?b - lander ?c - objective ?d - mode ?e - waypoint ?f - waypoint)
	:precondition (and (at ?a ?e) (at_lander ?b ?f) (can_traverse ?a ?e ?f) (can_traverse ?a ?f ?e) (equipped_for_imaging ?a) (available ?a) (visible ?e ?f) (visible ?f ?e) (have_image ?a ?c ?d) (at_soil_sample ?e) (at_soil_sample ?f) (visible_from ?c ?e) (channel_free ?b))
