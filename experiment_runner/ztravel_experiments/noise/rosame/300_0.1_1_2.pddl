...
(:action fly
	...
	:effect (and (at ?a ?c) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (next ?e ?d))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?e ?d) (next ?e ?f) (next ?f ?e))
	:effect (and (at ?a ?c) (next ?f ?d) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?f ?e))))
