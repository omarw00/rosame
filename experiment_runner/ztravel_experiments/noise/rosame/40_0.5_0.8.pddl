...
(:action fly
	...
	:precondition (and (at ?a ?b) (next ?e ?d))
	:effect (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (next ?d ?e) (not (at ?a ?b))  (not (next ?e ?d))))
...
(:action refuel
	...
	:precondition (and (fuel-level ?a ?c) (fuel-level ?a ?d) (next ?c ?d))
	:effect (and (at ?a ?b) (next ?d ?c) (not (fuel-level ?a ?c))  (not (fuel-level ?a ?d))  (not (next ?c ?d))))
