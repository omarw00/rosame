...
(:action fly
	...
	:precondition (and )
	:effect (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e)))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (fuel-level ?a ?e) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?f ?e))
	:effect (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?e ?f) (next ?f ?d) (not (at ?a ?b))  (not (fuel-level ?a ?e))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?f ?e))))
