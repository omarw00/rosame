...
(:action board
	...
	:effect (and  (not (at ?a ?b))  (not (in ?a ?c))))
...
(:action fly
	...
	:effect (and  (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (next ?d ?e))  (not (next ?e ?d))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (fuel-level ?a ?e) (next ?d ?f) (next ?e ?d) (next ?f ?e))
	:effect (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?d ?e) (next ?e ?f) (next ?f ?d) (not (fuel-level ?a ?e))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?f ?e))))
