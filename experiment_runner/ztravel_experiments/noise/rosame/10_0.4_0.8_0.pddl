...
(:action zoom
	...
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?e ?f))
	:effect (and (next ?f ?d) (next ?f ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?e ?f))))
