...
(:action zoom
	...
	:precondition (and (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?e ?d) (next ?e ?f))
	:effect (and (at ?a ?b) (at ?a ?c) (next ?f ?d) (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (fuel-level ?a ?f))))
