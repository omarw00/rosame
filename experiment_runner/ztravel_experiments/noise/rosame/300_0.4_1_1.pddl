...
(:action zoom
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?d ?e) (next ?e ?d) (next ?e ?f))
	:effect (and (at ?a ?c) (next ?f ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))))
