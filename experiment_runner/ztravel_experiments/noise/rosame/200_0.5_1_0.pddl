...
(:action zoom
	...
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?f ?e))
	:effect (and (next ?e ?d) (next ?e ?f) (next ?f ?d) (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?f ?e))))
