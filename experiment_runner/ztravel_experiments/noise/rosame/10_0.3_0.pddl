...
(:action zoom
	...
	:precondition (and )
	:effect (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?f) (next ?e ?d) (next ?e ?f) (next ?f ?d) (next ?f ?e)))

(:action refuel
	:parameters (?a - aircraft ?b - city ?c - flevel ?d - flevel)
	:precondition (and )
	:effect (and (at ?a ?b) (fuel-level ?a ?d) (next ?c ?d) (next ?d ?c)))
