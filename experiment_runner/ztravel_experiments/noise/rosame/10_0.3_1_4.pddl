...
(:action zoom
	...
	:precondition (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?e ?f) (next ?f ?d))
	:effect (and (at ?a ?b) (next ?f ?e) (not (fuel-level ?a ?e))))
