...
(:action zoom
	...
	:effect (and  (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?f ?d))  (not (next ?f ?e))))

(:action refuel
	:parameters (?a - aircraft ?b - city ?c - flevel ?d - flevel)
	:precondition (and (fuel-level ?a ?d) (next ?c ?d) (next ?d ?c))
	:effect (and ))
