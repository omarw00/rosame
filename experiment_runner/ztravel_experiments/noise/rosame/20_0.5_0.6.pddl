...
(:action zoom
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?e ?f) (next ?f ?d) (next ?f ?e))
	:effect (and ))

(:action refuel
	:parameters (?a - aircraft ?b - city ?c - flevel ?d - flevel)
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (next ?c ?d) (next ?d ?c))
	:effect (and ))
