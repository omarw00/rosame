...
(:action zoom
	...
	:precondition (and (fuel-level ?a ?d) (next ?d ?f) (next ?e ?d) (next ?e ?f))
	:effect (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?f ?d) (next ?f ?e) (not (fuel-level ?a ?d))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?e ?f))))
