...
(:action zoom
	...
	:precondition (and (at ?a ?c) (fuel-level ?a ?d) (next ?e ?d) (next ?e ?f))
	:effect (and (at ?a ?b) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?f ?d) (next ?f ?e) (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (next ?e ?d))  (not (next ?e ?f))))
