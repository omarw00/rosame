...
(:action fly
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (next ?d ?e) (next ?e ?d))
	:effect (and (at ?a ?c) (fuel-level ?a ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (next ?d ?e))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?e) (next ?d ?e) (next ?e ?d) (next ?e ?f) (next ?f ?d) (next ?f ?e))
	:effect (and (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?d ?f) (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?e))  (not (next ?d ?e))  (not (next ?e ?d))  (not (next ?e ?f))  (not (next ?f ?d))  (not (next ?f ?e))))
