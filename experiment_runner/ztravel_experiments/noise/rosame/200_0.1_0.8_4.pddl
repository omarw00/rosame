...
(:action zoom
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?e ?d) (next ?f ?d))
	:effect (and (at ?a ?c) (next ?e ?f) (next ?f ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))  (not (next ?f ?d))))
