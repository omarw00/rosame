...
(:action fly
	...
	:precondition (and (fuel-level ?a ?d) (fuel-level ?a ?e) (next ?d ?e))
	:effect (and (at ?a ?b) (at ?a ?c) (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (next ?e ?d) (next ?e ?f) (next ?f ?e))
	:effect (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?f ?d)))
