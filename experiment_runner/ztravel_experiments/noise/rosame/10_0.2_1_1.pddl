...
(:action fly
	...
	:precondition (and (at ?a ?c) (fuel-level ?a ?e) (next ?d ?e))
	:effect (and (next ?e ?d)))
...
(:action zoom
	...
	:effect (and  (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?e))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?e ?f))  (not (next ?f ?d))  (not (next ?f ?e))))
