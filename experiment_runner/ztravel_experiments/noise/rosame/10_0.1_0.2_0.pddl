...
(:action fly
	...
	:effect (and (at ?a ?c) (fuel-level ?a ?e) (next ?d ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))))
...
(:action zoom
	...
	:effect (and  (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?f ?d))  (not (next ?f ?e))))
