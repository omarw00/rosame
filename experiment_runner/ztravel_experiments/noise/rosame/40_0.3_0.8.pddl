...
(:action fly
	...
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (next ?d ?e) (next ?e ?d))
	:effect (and (fuel-level ?a ?e) (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (next ?d ?e))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?f ?e))
	:effect (and (fuel-level ?a ?e) (next ?e ?d) (next ?e ?f) (next ?f ?d) (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))  (not (next ?d ?e))  (not (next ?d ?f))  (not (next ?f ?e))))
