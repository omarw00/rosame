...
(:action fly
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?e) (next ?e ?d))
	:effect (and (at ?a ?c) (next ?d ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?e))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?e ?d))
	:effect (and (at ?a ?c) (next ?e ?f) (next ?f ?e) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))))
