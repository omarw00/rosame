...
(:action fly
	...
	:effect (and (fuel-level ?a ?e) (not (at ?a ?b))  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (next ?d ?e))  (not (next ?e ?d))))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and )
	:effect (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?e ?f) (next ?f ?d) (next ?f ?e)))
