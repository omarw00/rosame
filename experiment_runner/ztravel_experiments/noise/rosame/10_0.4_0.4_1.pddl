...
(:action fly
	...
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?e) (next ?d ?e))
	:effect (and ))

(:action zoom
	:parameters (?a - aircraft ?b - city ?c - city ?d - flevel ?e - flevel ?f - flevel)
	:precondition (and (at ?a ?b) (at ?a ?c) (fuel-level ?a ?e) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?e ?f))
	:effect (and (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?f ?d) (next ?f ?e)))
