...
(:action zoom
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?e ?f))
	:effect (and (at ?a ?c)))

(:action refuel
	:parameters (?a - aircraft ?b - city ?c - flevel ?d - flevel)
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (next ?c ?d))
	:effect (and (fuel-level ?a ?c) (next ?d ?c) (not (at ?a ?b))  (not (fuel-level ?a ?d))  (not (next ?c ?d))))
