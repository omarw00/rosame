...
(:action zoom
	...
	:precondition (and (at ?a ?c) (fuel-level ?a ?d) (fuel-level ?a ?f) (next ?d ?f) (next ?e ?d) (next ?e ?f) (next ?f ?e))
	:effect (and  (not (at ?a ?c))  (not (fuel-level ?a ?d))  (not (fuel-level ?a ?f))  (not (next ?d ?f))  (not (next ?e ?d))  (not (next ?f ?e))))
