...
(:action zoom
	...
	:precondition (and (at ?a ?b) (fuel-level ?a ?d) (fuel-level ?a ?e) (fuel-level ?a ?f) (next ?d ?e) (next ?d ?f) (next ?e ?d) (next ?e ?f) (next ?f ?d))
	:effect (and (at ?a ?c) (next ?f ?e) (not (at ?a ?b))  (not (next ?d ?e))  (not (next ?e ?d))))
