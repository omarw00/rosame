...
(:action unload-truck
	...
	:effect (and  (not (at ?b ?a))  (not (at ?c ?a))  (not (in ?b ?c))  (not (empty ?c))))

(:action board-truck
	:parameters (?a - driver ?b - location ?c - truck)
	:precondition (and (at ?a ?b))
	:effect (and (at ?c ?b) (driving ?a ?c) (empty ?c) (not (at ?a ?b))))

(:action disembark-truck
	:parameters (?a - driver ?b - location ?c - truck)
	:precondition (and (empty ?c))
	:effect (and (at ?a ?b) (at ?c ?b) (driving ?a ?c)))

(:action drive-truck
	:parameters (?a - driver ?b - location ?c - location ?d - truck)
	:precondition (and (driving ?a ?d) (path ?b ?c))
	:effect (and ))
