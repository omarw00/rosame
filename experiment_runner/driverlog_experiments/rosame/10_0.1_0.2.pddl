...
(:action drive-truck
	...
	:precondition (and (at ?a ?c) (at ?d ?b) (at ?d ?c) (driving ?a ?d) (link ?c ?b) (path ?b ?c))
	:effect (and (at ?a ?b) (link ?b ?c) (path ?c ?b) (empty ?d) (not (at ?a ?c))  (not (at ?d ?b))  (not (at ?d ?c))  (not (driving ?a ?d))  (not (link ?c ?b))  (not (path ?b ?c))))
