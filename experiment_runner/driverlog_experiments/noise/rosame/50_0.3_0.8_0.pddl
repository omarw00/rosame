...
(:action board-truck
	...
	:effect (and (at ?c ?b) (empty ?c) (not (at ?a ?b))  (not (driving ?a ?c))))

(:action disembark-truck
	:parameters (?a - driver ?b - location ?c - truck)
	:precondition (and (driving ?a ?c) (empty ?c))
	:effect (and (at ?a ?b) (at ?c ?b) (not (driving ?a ?c))  (not (empty ?c))))

(:action drive-truck
	:parameters (?a - driver ?b - location ?c - location ?d - truck)
	:precondition (and (at ?d ?b) (link ?b ?c) (link ?c ?b))
