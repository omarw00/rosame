...
(:action drive-truck
	...
	:precondition (and (at ?d ?b) (at ?d ?c) (link ?b ?c))
	:effect (and (link ?c ?b) (empty ?d) (not (at ?d ?b))  (not (at ?d ?c))))
