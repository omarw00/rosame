...
from macq.trace import Action, State, PlanningObject, Fluent, Trace, Step
...
class ExtractStaticFluents(LPGroundingStrategy):
    ...
    def ground_state_variables(self):
        ...
        return variables
# gen = Generator("/Users/omarwattad/Documents/Action Model - Research/rosame/experiment_runner/ztravel_experiments/domain.pddl", "/Users/omarwattad/Documents/Action Model - Research/rosame/experiment_runner/problem_generator/ztravel_problems/pfile1.pddl", observe_static_fluents=True)
# plan = gen.generate_plan(from_ipc_file=True, filename="/Users/omarwattad/Documents/Action Model - Research/rosame/experiment_runner/problem_generator/ztravel_problems/pfile1_random_walk.solution")
# traj = gen.generate_single_trace_from_plan(plan)
