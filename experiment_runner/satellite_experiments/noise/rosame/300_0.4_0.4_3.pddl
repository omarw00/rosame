...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (supports ?b ?c) (power_on ?b) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and  (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (power_on ?b))  (not (calibrated ?b))  (not (have_image ?a ?c))  (not (calibration_target ?a ?b))))
