...
(:action switch_on
	...
	:effect (and (power_avail ?b) (not (power_on ?a))  (not (calibrated ?a))))
...
(:action calibrate
	...
	:precondition (and (on_board ?b ?c) (power_avail ?c) (calibrated ?b))
	:effect (and (pointing ?a ?c) (power_on ?b) (calibration_target ?a ?b) (not (on_board ?b ?c))  (not (power_avail ?c))  (not (calibrated ?b))))
