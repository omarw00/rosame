...
(:action calibrate
	...
	:precondition (and (pointing ?a ?c) (power_avail ?c) (power_on ?b) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?c)))

(:action take_image
	:parameters (?a - direction ?b - instrument ?c - mode ?d - satellite)
	:precondition (and (supports ?b ?c) (power_avail ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (pointing ?a ?d)))
