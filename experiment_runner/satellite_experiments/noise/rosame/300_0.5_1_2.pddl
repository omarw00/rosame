...
(:action take_image
	...
	:precondition (and (pointing ?a ?d) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (supports ?b ?c) (power_avail ?d) (power_on ?b) (have_image ?a ?c) (not (pointing ?a ?d))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
