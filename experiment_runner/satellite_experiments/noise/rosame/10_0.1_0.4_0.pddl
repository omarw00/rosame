...
(:action take_image
	...
	:precondition (and (power_avail ?d) (power_on ?b))
	:effect (and (on_board ?b ?d) (supports ?b ?c) (pointing ?a ?d) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b) (not (power_avail ?d))  (not (power_on ?b))))
