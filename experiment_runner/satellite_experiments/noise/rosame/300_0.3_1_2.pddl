...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (supports ?b ?c) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (calibration_target ?a ?b))
	:effect (and  (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (power_on ?b))  (not (calibration_target ?a ?b))))
