...
(:action calibrate
	...
	:precondition (and (on_board ?b ?c) (pointing ?a ?c) (power_avail ?c) (power_on ?b))
	:effect (and (calibrated ?b) (calibration_target ?a ?b) (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_avail ?c))  (not (power_on ?b))))
