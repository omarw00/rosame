...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (pointing ?a ?d) (power_avail ?d) (have_image ?a ?c))
	:effect (and (supports ?b ?c) (power_on ?b) (calibrated ?b) (calibration_target ?a ?b) (not (on_board ?b ?d))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (have_image ?a ?c))))
