...
(:action switch_off
	...
	:effect (and (on_board ?a ?b) (power_avail ?b) (power_on ?a) (not (calibrated ?a))))
...
(:action calibrate
	...
	:effect (and  (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_avail ?c))  (not (calibration_target ?a ?b))))
