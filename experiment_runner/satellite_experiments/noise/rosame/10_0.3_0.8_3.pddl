...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (power_avail ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c))
	:effect (and (supports ?b ?c) (pointing ?a ?d) (calibration_target ?a ?b) (not (on_board ?b ?d))  (not (power_avail ?d))  (not (power_on ?b))  (not (calibrated ?b))  (not (have_image ?a ?c))))
