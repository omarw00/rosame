...
(:action calibrate
	...
	:effect (and (power_on ?b) (calibrated ?b) (calibration_target ?a ?b)))
...
(:action take_image
	...
	:effect (and  (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (power_on ?b))  (not (have_image ?a ?c))  (not (calibration_target ?a ?b))))
