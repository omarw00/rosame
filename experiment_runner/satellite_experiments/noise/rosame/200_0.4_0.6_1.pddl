...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (supports ?b ?c) (pointing ?a ?d) (power_avail ?d) (have_image ?a ?c))
	:effect (and (power_on ?b) (calibrated ?b) (calibration_target ?a ?b) (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (have_image ?a ?c))))
