...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (power_avail ?d) (calibrated ?b))
	:effect (and (on_board ?b ?d) (pointing ?a ?d) (power_on ?b) (have_image ?a ?c) (calibration_target ?a ?b) (not (supports ?b ?c))  (not (power_avail ?d))  (not (calibrated ?b))))
