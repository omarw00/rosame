...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (pointing ?a ?d) (power_avail ?d) (calibration_target ?a ?b))
	:effect (and  (not (on_board ?b ?d))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (calibration_target ?a ?b))))
