...
(:action calibrate
	...
	:precondition (and (pointing ?a ?c) (power_avail ?c) (power_on ?b))
	:effect (and (on_board ?b ?c) (calibrated ?b) (calibration_target ?a ?b) (not (pointing ?a ?c))  (not (power_avail ?c))  (not (power_on ?b))))
