...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (pointing ?a ?d) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (power_avail ?d) (power_on ?b) (calibrated ?b) (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (have_image ?a ?c))  (not (calibration_target ?a ?b))))
