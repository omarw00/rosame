...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (pointing ?a ?d) (power_on ?b) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (power_avail ?d) (have_image ?a ?c) (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_on ?b))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
