...
(:action switch_off
	...
	:effect (and (on_board ?a ?b) (power_avail ?b) (not (power_on ?a))))
...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (pointing ?a ?d) (power_avail ?d))
	:effect (and (on_board ?b ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b) (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_avail ?d))))
