...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (supports ?b ?c) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and  (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
