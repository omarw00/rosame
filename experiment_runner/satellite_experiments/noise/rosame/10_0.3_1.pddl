...
(:action switch_off
	:parameters (?a - instrument ?b - satellite)
	:precondition (and (power_avail ?b) (power_on ?a) (calibrated ?a))
	:effect (and  (not (power_avail ?b))  (not (power_on ?a))  (not (calibrated ?a))))
...
(:action calibrate
	...
	:effect (and  (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_on ?b))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
...
(:action take_image
	...
	:effect (and  (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (pointing ?a ?d))))
