...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and (supports ?b ?c) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (have_image ?a ?c) (not (on_board ?b ?d))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
