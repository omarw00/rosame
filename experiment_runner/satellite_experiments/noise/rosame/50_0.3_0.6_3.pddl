...
(:action switch_on
	...
	:effect (and (power_on ?a) (calibrated ?a) (not (power_avail ?b))))
...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (power_on ?b) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (pointing ?a ?d) (power_avail ?d) (calibrated ?b) (have_image ?a ?c)))
