...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (calibrated ?b) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (have_image ?a ?c) (not (supports ?b ?c))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
