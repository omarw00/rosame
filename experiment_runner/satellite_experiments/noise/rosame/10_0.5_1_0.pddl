...
(:action calibrate
	...
	:precondition (and (on_board ?b ?c) (pointing ?a ?c) (power_on ?b) (calibration_target ?a ?b))
	:effect (and (power_avail ?c) (calibrated ?b) (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_on ?b))  (not (calibration_target ?a ?b))))
