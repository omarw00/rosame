...
(:action calibrate
	...
	:precondition (and (power_avail ?c) (power_on ?b) (calibrated ?b))
	:effect (and (on_board ?b ?c) (pointing ?a ?c) (calibration_target ?a ?b) (not (power_avail ?c))  (not (power_on ?b))  (not (calibrated ?b))))
