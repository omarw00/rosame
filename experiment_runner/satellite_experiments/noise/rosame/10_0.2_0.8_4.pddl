...
(:action calibrate
	...
	:effect (and (on_board ?b ?c) (pointing ?a ?c) (power_avail ?c) (power_on ?b) (calibration_target ?a ?b) (not (calibrated ?b))))
...
(:action take_image
	...
	:effect (and  (not (on_board ?b ?d))  (not (supports ?b ?c))  (not (power_avail ?d))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
