...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (pointing ?a ?d) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and (supports ?b ?c) (power_avail ?d) (power_on ?b) (not (on_board ?b ?d))  (not (pointing ?a ?d))  (not (calibrated ?b))  (not (have_image ?a ?c))  (not (calibration_target ?a ?b))))
