...
(:action calibrate
	...
	:precondition (and (pointing ?a ?c) (power_avail ?c) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?c) (power_on ?b) (calibrated ?b) (not (pointing ?a ?c))  (not (power_avail ?c))  (not (calibration_target ?a ?b))))
