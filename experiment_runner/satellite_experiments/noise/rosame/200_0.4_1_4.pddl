...
(:action calibrate
	...
	:precondition (and (on_board ?b ?c) (pointing ?a ?c) (power_avail ?c))
	:effect (and (power_on ?b) (calibrated ?b) (calibration_target ?a ?b) (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_avail ?c))))
