...
(:action take_image
	...
	:precondition (and (on_board ?b ?d) (supports ?b ?c))
	:effect (and (pointing ?a ?d) (power_avail ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b) (not (on_board ?b ?d))  (not (supports ?b ?c))))
