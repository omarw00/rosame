...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (calibrated ?b) (not (supports ?b ?c))  (not (calibration_target ?a ?b))))
