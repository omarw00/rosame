...
(:action calibrate
	...
	:effect (and (on_board ?b ?c) (pointing ?a ?c) (power_on ?b) (calibrated ?b) (calibration_target ?a ?b)))
...
(:action take_image
	...
	:effect (and  (not (power_avail ?d))  (not (calibrated ?b))  (not (calibration_target ?a ?b))))
