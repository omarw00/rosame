...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c) (calibration_target ?a ?b))
	:effect (and (on_board ?b ?d) (not (power_avail ?d))  (not (calibration_target ?a ?b))))
