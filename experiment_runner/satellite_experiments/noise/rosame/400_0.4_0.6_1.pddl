...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (power_avail ?d) (power_on ?b) (calibrated ?b) (have_image ?a ?c))
	:effect (and (on_board ?b ?d) (pointing ?a ?d) (calibration_target ?a ?b) (not (supports ?b ?c))  (not (power_avail ?d))  (not (power_on ?b))  (not (calibrated ?b))  (not (have_image ?a ?c))))
