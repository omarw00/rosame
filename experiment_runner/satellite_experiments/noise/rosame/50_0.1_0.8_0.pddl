...
(:action switch_on
	...
	:precondition (and (on_board ?a ?b) (power_avail ?b) (power_on ?a))
...
(:action calibrate
	...
	:precondition (and (on_board ?b ?c) (pointing ?a ?c) (power_avail ?c) (power_on ?b) (calibrated ?b))
	:effect (and (calibration_target ?a ?b) (not (on_board ?b ?c))  (not (pointing ?a ?c))  (not (power_avail ?c))  (not (calibrated ?b))))
