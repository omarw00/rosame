...
(:action take_image
	...
	:precondition (and (supports ?b ?c) (pointing ?a ?d) (power_avail ?d) (power_on ?b) (calibrated ?b))
	:effect (and (on_board ?b ?d) (have_image ?a ?c) (calibration_target ?a ?b) (not (supports ?b ?c))  (not (pointing ?a ?d))  (not (power_avail ?d))  (not (power_on ?b))  (not (calibrated ?b))))
