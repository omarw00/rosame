...
(:action lift
	...
	:precondition (and (at ?a ?d) (at ?b ?d) (at ?c ?d) (on ?b ?c) (available ?a) (clear ?b))
	:effect (and (lifting ?a ?b) (clear ?c) (not (at ?b ?d))  (not (on ?b ?c))  (not (available ?a))  (not (clear ?b))))
...
(:action unload
	:parameters (?a - hoist ?b - crate ?c - truck ?d - place)
	:precondition (and (in ?b ?c) (available ?a))
	:effect (and (at ?a ?d) (at ?c ?d) (lifting ?a ?b) (not (in ?b ?c))  (not (available ?a))))
