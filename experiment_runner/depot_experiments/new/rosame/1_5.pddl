...
(:action lift
	...
	:precondition (and (at ?a ?d) (at ?b ?d) (at ?c ?d) (on ?b ?b) (on ?b ?c) (available ?a) (clear ?b))
	:effect (and (lifting ?a ?b) (clear ?c) (not (at ?b ?d))  (not (on ?b ?b))  (not (on ?b ?c))  (not (available ?a))  (not (clear ?b))))
