...
(:action load
	...
	:precondition (and (at ?d ?c) (on ?a ?a) (lifting ?a ?b) (available ?b) (clear ?a))
	:effect (and (at ?a ?c) (at ?b ?c) (in ?a ?d) (not (at ?d ?c))  (not (on ?a ?a))  (not (lifting ?a ?b))  (not (available ?b))  (not (clear ?a))))
