...
(:action lift
	...
	:effect (and (at ?b ?c) (at ?d ?c) (clear ?d) (not (at ?a ?c))  (not (on ?a ?d))  (not (available ?b))  (not (clear ?a))))
...
(:action load
	...
	:precondition (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (lifting ?a ?b) (available ?b) (clear ?a))
	:effect (and  (not (at ?a ?c))  (not (at ?b ?c))  (not (at ?d ?c))  (not (lifting ?a ?b))  (not (available ?b))  (not (clear ?a))))

(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and )
	:effect (and (at ?a ?c) (at ?b ?c) (on ?a ?a) (in ?a ?d) (lifting ?a ?b) (available ?b) (clear ?a)))
