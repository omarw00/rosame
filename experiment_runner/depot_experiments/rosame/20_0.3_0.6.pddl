...
(:action drop
	...
	:effect (and (at ?a ?c) (on ?a ?a) (on ?a ?d) (lifting ?a ?b) (available ?b) (clear ?a) (not (clear ?d))))
...
(:action unload
	...
	:effect (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?a) (in ?a ?d) (lifting ?a ?b) (available ?b) (not (clear ?a))))
