...
(:action lift
	...
	:effect (and (at ?a ?c) (available ?b) (clear ?d) (not (on ?a ?d))  (not (clear ?a))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?a ?c) (at ?d ?c) (clear ?a))
	:effect (and (at ?b ?c) (on ?a ?a) (in ?a ?d) (lifting ?a ?b) (available ?b)))
