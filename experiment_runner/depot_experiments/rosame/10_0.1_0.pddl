...
(:action drop
	...
	:effect (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?d) (available ?b) (clear ?a) (not (clear ?d))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?a) (in ?a ?d) (available ?b) (clear ?a))
	:effect (and  (not (at ?a ?c))  (not (at ?b ?c))  (not (at ?d ?c))  (not (on ?a ?a))  (not (available ?b))))
