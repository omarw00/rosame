...
(:action lift
	...
	:precondition (and (at ?a ?c) (at ?b ?c) (on ?a ?d) (available ?b) (clear ?a))
	:effect (and (lifting ?a ?b) (clear ?d) (not (at ?a ?c))  (not (on ?a ?d))  (not (available ?b))  (not (clear ?a))))

(:action drop
	:parameters (?a - crate ?b - hoist ?c - place ?d - surface)
	:precondition (and (at ?d ?c) (lifting ?a ?b) (clear ?d))
	:effect (and (at ?a ?c) (at ?b ?c) (on ?a ?d) (available ?b) (clear ?a) (not (at ?d ?c))  (not (lifting ?a ?b))  (not (clear ?d))))
