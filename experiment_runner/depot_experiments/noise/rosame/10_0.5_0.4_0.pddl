...
(:action load
	...
	:precondition (and )
	:effect (and (at ?a ?c) (at ?b ?c) (on ?a ?a) (in ?a ?d) (available ?b) (clear ?a)))

(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (on ?a ?a) (in ?a ?d) (lifting ?a ?b) (clear ?a))
	:effect (and  (not (on ?a ?a))  (not (in ?a ?d))  (not (lifting ?a ?b))  (not (clear ?a))))
