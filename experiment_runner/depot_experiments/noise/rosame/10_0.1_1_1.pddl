...
(:action load
	...
	:precondition (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?a) (lifting ?a ?b) (available ?b))
	:effect (and  (not (at ?a ?c))  (not (at ?b ?c))  (not (at ?d ?c))  (not (on ?a ?a))  (not (lifting ?a ?b))  (not (available ?b))))
