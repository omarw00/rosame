...
(:action drop
	...
	:effect (and (at ?a ?c) (on ?a ?a) (on ?a ?d) (available ?b) (clear ?a) (not (lifting ?a ?b))  (not (clear ?d))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?a ?c) (at ?d ?c) (lifting ?a ?b) (clear ?a))
	:effect (and (at ?b ?c) (on ?a ?a) (in ?a ?d) (available ?b)))
