...
(:action drop
	:parameters (?a - crate ?b - hoist ?c - place ?d - surface)
	:precondition (and (at ?b ?c) (on ?a ?d))
	:effect (and (at ?a ?c) (on ?a ?a) (lifting ?a ?b) (available ?b) (clear ?a) (clear ?d) (not (on ?a ?d))))

(:action load
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and )
	:effect (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (in ?a ?d) (lifting ?a ?b) (clear ?a)))
