...
(:action lift
	...
	:precondition (and (at ?b ?c) (on ?a ?d) (available ?b) (clear ?a))
	:effect (and (at ?a ?c) (lifting ?a ?b) (clear ?d) (not (on ?a ?d))  (not (available ?b))  (not (clear ?a))))

(:action drop
	:parameters (?a - crate ?b - hoist ?c - place ?d - surface)
	:precondition (and (at ?a ?c) (lifting ?a ?b) (clear ?d))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (in ?a ?d) (available ?b))
