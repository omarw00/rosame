...
(:action lift
	...
	:precondition (and (at ?a ?c) (at ?b ?c) (on ?a ?d) (clear ?a))
	:effect (and (lifting ?a ?b) (available ?b) (clear ?d) (not (at ?a ?c))  (not (on ?a ?d))  (not (clear ?a))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?d ?c) (in ?a ?d) (lifting ?a ?b) (available ?b))
	:effect (and (at ?b ?c) (clear ?a) (not (at ?d ?c))  (not (in ?a ?d))  (not (lifting ?a ?b))  (not (available ?b))))
