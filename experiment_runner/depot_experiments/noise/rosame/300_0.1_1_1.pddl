...
(:action drop
	...
	:effect (and (at ?b ?c) (at ?d ?c) (on ?a ?a) (on ?a ?d) (clear ?a) (not (at ?a ?c))  (not (lifting ?a ?b))  (not (available ?b))  (not (clear ?d))))

(:action load
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (in ?a ?d) (lifting ?a ?b))
	:effect (and (available ?b) (not (in ?a ?d))  (not (lifting ?a ?b))))
