...
(:action drop
	:parameters (?a - crate ?b - hoist ?c - place ?d - surface)
	:precondition (and (at ?a ?c) (at ?b ?c) (lifting ?a ?b) (available ?b) (clear ?d))
...
(:action load
	...
	:precondition (and (at ?a ?c) (at ?d ?c) (on ?a ?a) (lifting ?a ?b))
	:effect (and (at ?b ?c) (in ?a ?d) (available ?b) (clear ?a)))
