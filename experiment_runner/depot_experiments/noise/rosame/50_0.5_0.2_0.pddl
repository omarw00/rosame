...
(:action load
	...
	:precondition (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?a) (lifting ?a ?b) (available ?b) (clear ?a))
	:effect (and  (not (at ?a ?c))  (not (at ?b ?c))  (not (at ?d ?c))  (not (on ?a ?a))  (not (lifting ?a ?b))  (not (available ?b))  (not (clear ?a))))

(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?a ?c) (at ?d ?c) (on ?a ?a) (available ?b) (clear ?a))
	:effect (and ))
