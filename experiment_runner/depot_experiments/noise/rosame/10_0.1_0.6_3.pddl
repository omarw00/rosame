...
(:action lift
	...
	:effect (and (lifting ?a ?b) (clear ?a) (clear ?d) (not (at ?a ?c))  (not (on ?a ?a))  (not (on ?a ?d))  (not (available ?b))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and )
	:effect (and (at ?b ?c) (at ?d ?c) (on ?a ?a) (in ?a ?d) (lifting ?a ?b) (available ?b) (clear ?a)))
