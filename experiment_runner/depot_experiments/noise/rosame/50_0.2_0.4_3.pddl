...
(:action drop
	...
	:effect (and (at ?a ?c) (at ?b ?c) (at ?d ?c) (on ?a ?a) (on ?a ?d) (available ?b) (clear ?a) (not (lifting ?a ?b))  (not (clear ?d))))
...
(:action unload
	:parameters (?a - crate ?b - hoist ?c - place ?d - truck)
	:precondition (and (at ?d ?c) (in ?a ?d) (available ?b))
	:effect (and (at ?b ?c) (lifting ?a ?b) (not (in ?a ?d))  (not (available ?b))))
