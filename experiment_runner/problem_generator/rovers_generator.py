...
def generate_strips_problems(output_directory: Path, num_probs_per_difficulty: int = 100):
    ...
    for i in range(num_probs_per_difficulty):
        ...
        generate_problem_command = [
            ...
            "-v", "/Users/omarwattad/Documents/Action-Model-Research/rosame/experiment_runner/problem_generator:/probgen",
            "ubuntu", "/bin/bash", "-c",
            f"/probgen/rovergen {seed} {num_rovers} {num_waypoints} {num_objectives} {num_cameras} {num_goals}"
        ]
...
def main():
    ...
    if sys.argv[2] == "numeric":
        ...
        generate_strips_problems(Path(output_directory),25)
