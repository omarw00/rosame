(define (domain rover)
       ...
       (:action sample_soil
              ...
              :precondition (and (at ?x ?p) (at_soil_sample ?p)
                     (equipped_for_soil_analysis ?x) (store_of ?x ?s) (empty ?s))
       ...
       (:action sample_rock
              ...
              :precondition (and (at ?x ?p) (at_rock_sample ?p)
                     (equipped_for_rock_analysis ?x) (store_of ?x ?s)(empty ?s))
       ...
       (:action drop
              ...
              :precondition (and (store_of ?x ?y) (full ?y))
       ...
       (:action communicate_image_data
              ...
              :precondition (and (at ?r ?x)
                     (at_lander ?l ?y)(have_image ?m ?o ?r)
                     (visible ?x ?y)(available ?r)(channel_free ?l))
              :effect (and (not (available ?r))
                     (not (channel_free ?l))(channel_free ?l)
                     (communicated_image_date ?m ?o)(available ?r))
       )
)